...
Attachment.prototype.initialize = function() {
    ...
    var t = window.localStorage.getItem("HideArms");
    t && "true" === t && (this.arms.model.meshInstances[0].material = this.app.assets.find("ArmsTransparent").resource)
}
,
...
Attachment.prototype.attachMagazine = function() {
    ...
    "P90" == this.weaponName ? this.magazineEntity.setLocalEulerAngles(90, 0, 0) : this.magazineEntity.setLocalEulerAngles(0, 0, 0),
...
Attachment.prototype.setMuzzle = function() {
    ...
    Date.now() - this.lastSmokeTime > 1500 && (this.lastSmokeTime = Date.now()),
...
Movement.attributes.add("newGravity", {
    type: "number",
    default: -50
}),
...
Movement.attributes.add("collisionMargin", {
    type: "number",
    default: .1
}),
...
Movement.attributes.add("vibrationFactor", {
    type: "number"
}),
...
Movement.attributes.add("characterHat", {
    type: "entity"
}),
Movement.attributes.add("characterHatHolder", {
    type: "entity"
}),
...
Movement.attributes.add("playerManager", {
    type: "entity"
}),
Movement.prototype.initialize = function() {
    if (this.force = new pc.Vec3,
    this.eulers = new pc.Vec3,
    this.nextEulers = new pc.Vec3,
    this.lastDelta = 0,
    this.rigidbodyMass = this.entity.rigidbody.mass,
    this.lastVariable = Date.now(),
    this.lastAmmoUpdate = Date.now(),
    pc.dt = 1 / 60,
    ...
    this.collisionHeight = this.entity.collision.height / 2,
    this.dynamicGravity = 0,
    this.animationCurrentTime = 0,
    this.animationDuration = 0,
    this.fullTimestamp = 0,
    this.isForward = !1,
    this.isBackward = !1,
    this.isLeft = !1,
    this.isRight = !1,
    ...
    this.entity.rigidbody.body.setCcdMotionThreshold(1),
    this.entity.rigidbody.body.setCcdSweptSphereRadius(.2),
    ...
    this.app.on("Player:DisableProtection", this.setProtectionState, this),
    this.app.on("Player:Shake", this.shake.bind(this)),
    this.app.on("Event:Victory", this.showVictory.bind(this), this),
    this.isCarryFlag = !1,
    this.team = "red",
    this.isInBase = !1,
    this.app.on("Base:Enter", this.onBaseEnter.bind(this), this),
    this.app.on("Base:Leave", this.onBaseLeave.bind(this), this),
    this.app.on("Player:Capture", this.onCapture.bind(this), this),
    this.app.on("Score:SaveFlag", this.onSaveFlag.bind(this), this),
    this.app.on("Team:Capture", this.onTeamCapture.bind(this), this),
    this.app.on("Game:Finished", this.onFinished, this),
    this.app.on("Player:Ready", this.onReady.bind(this), this),
    document.addEventListener("pointerlockchange", this.onPointerStatusChange.bind(this), !1),
    ...
    var e = window.localStorage.getItem("MouseSensitivity");
    e && parseInt(e) > 0 && (e = parseInt(e),
    this.mouseSensitivity = e / 100);
    var i = window.localStorage.getItem("InvertAxis");
    this.invertAxis = !(!i || null === i) && i,
    Utils.isMobile() && this.setTouchState(),
    pc.controls = this,
    this.onReady(),
    this.setSkin(pc.currentSkin),
...
,
Movement.prototype.onFinished = function() {
    this.isShooting = !1,
    this.keyboard.up = !1,
...
,
Movement.prototype.setProtectionState = function(t) {
    this.interface.hideProtectionState()
}
,
Movement.prototype.onPointerStatusChange = function(t) {
    pc.Mouse.isPointerLocked() || (this.isFocusing = !1)
}
,
Movement.prototype.onReady = function() {
    if (this.setStartWeapon(this.startWeaponEntity, this.startAmmoEntity),
    "capture-the-flag" == pc.currentMode) {
        this.team = pc.currentTeam,
        this.interface.setTeam(this.team);
        var t = this.getRespawnPosition();
        t && this.entity.rigidbody.teleport(t.x, t.y, t.z, 0, 0, 0),
        this.interface.openBuyMenu()
    }
    this.app.fire("Game:Ready", !0),
    this.app.fire("Item:RequestDamages", !0)
}
,
...
,
Movement.prototype.attachHat = function() {
    var t = this.characterEntity.findByName("Head");
    if (this.characterHatHolder.reparent(t),
    this.characterHatHolder.setLocalScale(100, 100, 100),
    pc.hat) {
        var e = this.app.assets.find(pc.hat + "-Hat");
        e ? this.characterHat.model.asset = e : this.characterHatHolder.enabled = !1
    }
}
,
Movement.prototype.onCapture = function() {
    if (this.isDeath)
        return !1;
    this.interface.showAlert("You have the flag, go to the team base!", "success", "flag"),
    this.interface.objectiveEntity.enabled = !0,
    this.interface.objectiveText.element.text = "Deliver flag to your base",
    this.isCarryFlag = !0,
    this.entity.sound.play("TakeItem")
}
,
Movement.prototype.onSaveFlag = function(t, e) {
    if (this.isDeath)
        return !1;
    pc.userId == t ? (this.interface.showScore("Flag Captured!", 30, !1),
    this.interface.objectiveEntity.enabled = !1,
    this.isCarryFlag = !1) : e == this.team && (this.interface.showScore("Flag Captured!", 10, !1),
    this.interface.objectiveEntity.enabled = !1)
}
,
Movement.prototype.onTeamCapture = function() {
    if (this.isDeath)
        return !1;
    this.interface.showAlert("Your team has flag, defend your teammates!", "success", "flag"),
    this.interface.objectiveEntity.enabled = !0,
    this.interface.objectiveText.element.text = "Defend your teammates"
}
,
Movement.prototype.onBaseLeave = function() {
    this.isInBase = !1
}
,
Movement.prototype.onBaseEnter = function(t, e) {
    return !this.isDeath && (!this.inControl && (("TeamRed" == t && "red" == this.team || "TeamBlue" == t && "blue" == this.team) && (this.isInBase = !0),
    e ? (("TeamBlue" == t && "blue" == this.team || "TeamRed" == t && "red" == this.team) && this.app.fire("Flag:Back", this.team, this.hash),
    ("TeamRed" == t && "blue" == this.team || "TeamBlue" == t && "red" == this.team) && !this.isCarryFlag && (this.playerManager.script.playerManager.getTeamFlagCarriers(this.team) || this.app.fire("Flag:Captured", this.team, this.hash)),
    !1) : (("TeamBlue" == t && "red" == this.team || "TeamRed" == t && "blue" == this.team) && !this.isCarryFlag && (this.playerManager.script.playerManager.getTeamFlagCarriers(this.team) || this.app.fire("Flag:Captured", this.team, this.hash)),
    void (("TeamRed" == t && "red" == this.team || "TeamBlue" == t && "blue" == this.team) && this.isCarryFlag && (this.playerManager.script.playerManager.getFlagCarriers(this.team) || (this.app.fire("Flag:Saved", this.team, this.hash),
    this.isCarryFlag = !1))))))
}
,
...
Movement.prototype.mouseDown = function(t) {
    return !this.inControl && (this.interface.isInventoryEnabled || this.gameFinished || this.app.mouse.enablePointerLock(),
...
Movement.prototype.doRaycast = function(t) {
    ...
    var n = this.takePointEntity.getPosition()
      , a = 1e3;
    for (var o in this.interactiveObjects) {
        var r = this.interactiveObjects[o];
        if (r && r.enabled && r.script && r.script.interactive) {
            var h = n.clone().sub(r.getPosition()).length();
            h < a && h < 1.5 && ("Door" === r.name ? (this.setInteractive(r, r.script.interactive),
...
Movement.prototype.takeItem = function(t) {
    ...
    if (this.inventory.checkEnoughSpace() && "Bag" != t.script.weapon.type)
        ...
        !1;
    if (t.script.weapon.onlySingle && this.inventory.hasItemType(t.script.weapon.type) && "Bag" != t.script.weapon.type)
...
Movement.prototype.takeWeapon = function(t) {
    ...
    this.inventory.checkEnoughSpace(i) && !this.isSwapActive)
        return this.interface.showAlert("You don't have enough space in your bag!", "error", "bag"),
        !1;
    ...
    var a = t.script.weapon.ammoType;
    a = Utils.clearId(a);
    var o = this.itemSpawnEntity.script.itemSpawn.getWeaponDetails(a);
    if (o = o.entity,
    t.isSpawn && !0 === t.isSpawn) {
        var r = Math.round(10 * Math.random());
        o && (this.inventory.addItem(o.script.weapon.name, o.script.weapon.ammoType, o.script.weapon.type, o.script.weapon.icon, o.script.weapon.maskIcon, r),
    ...
    var h = this.inventory.checkAmmo(this.currentWeaponDetails)
      , c = this.currentWeaponDetails.currentAmmo;
    return h > 0 && 0 === c && this.reload(),
...
Movement.prototype.setMovement = function() {
    ...
    this.jumpingTime + this.jumpLandTime < this.fullTimestamp && (this.isForward = !1,
    this.isBackward = !1,
    this.isLeft = !1,
    this.isRight = !1),
    (this.isPressed("W") && !this.inControl || this.keyboard.up) && (this.isForward = !0),
    (this.isPressed("A") && !this.inControl || this.keyboard.left) && (this.isLeft = !0),
    (this.isPressed("D") && !this.inControl || this.keyboard.right) && (this.isRight = !0),
    (this.isPressed("S") && !this.inControl || this.keyboard.down) && (this.isBackward = !0),
    this.isForward && (i += t.x,
    s += t.z,
    n = !0,
    a = !0,
    ...
    this.wasPressed("X") && "battle-royale" == pc.currentMode && this.useNeedle(),
    ...
    this.wasPressed("TAB") && "capture-the-flag" == pc.currentMode && (this.isInBase ? this.interface.toggleBuyMenu() : this.interface.showAlert("You can only select weapons in-base.", "error", "flag"))),
    0 !== i && 0 !== s) {
        var o = this.power;
        this.isCrouching && (o *= .4),
        this.isFocusing && (o *= .8),
        "Handgun" == this.attachment.type && (o *= 1.2),
        this.isShifting || (o *= 1.35),
        this.isJumping > 0 && (o *= 1.05),
        this.currentSpeed = o / this.animationSpeed;
        var r = this.lastCurrentPower;
        n && this.height < 1.5 && (this.forceX = i,
        this.forceZ = s,
        this.lastCurrentPower = o),
        a || (r *= .7,
        ...
        var h = this.currentSpeed * this.vibrationFactor;
        this.isFocusing || this.isCrouching ? this.runVibration = 0 : this.runVibration = .2 * Math.cos(this.timestamp / h),
...
,
Movement.prototype.setStartWeapon = function(t, e, i) {
    void 0 !== pc.perkItem && pc.perkItem && this.inventory.addItem(pc.perkItem.name, pc.perkItem.ammoType, pc.perkItem.type, pc.perkItem.icon, pc.perkItem.maskIcon, pc.perkItemAmount),
    this.currentWeaponDetails && this.inventory.removeItemFromInventory(this.inventory.findItem(this.currentWeaponDetails.name), !0),
    this.inventory.addItem(t.script.weapon.name, t.script.weapon.ammoType, t.script.weapon.type, t.script.weapon.icon, t.script.weapon.maskIcon);
    var s = 10;
    "capture-the-flag" == pc.currentMode && (s = 999),
    i > 0 && (s = i),
    this.inventory.addItem(e.script.weapon.name, e.script.weapon.ammoType, e.script.weapon.type, e.script.weapon.icon, e.script.weapon.maskIcon, s),
...
Movement.prototype.useNeedle = function() {
    ...
    void this.setAnimation("Left-Needle", 1, .2, !1, function(t) {})) : (this.interface.showAlert("You don't have needle in your backpack!", "error", "needle"),
    !1))
}
,
...
Movement.prototype.setThrowing = function() {
    if (this.isThrowingStarted) {
        var t = (Date.now() - this.throwingStart) * this.throwingFactor;
        t > 0 && this.interface.setThrowingBar(t),
        this.maxThrowingTime < Date.now() - this.throwingStart && this.throwGrenade()
    } else
        this.interface.hideThrowingBar()
}
,
...
Movement.prototype.addGrenade = function() {
    var t = this.inventory.getActiveGrenade();
    this.app.fire("Grenade:Throw", this.hash, this.throwPosition, this.throwDirection, 2e3, t, !0),
    this.app.fire("Player:Throw", Utils.encodeFloat(this.throwPosition.x), Utils.encodeFloat(this.throwPosition.y), Utils.encodeFloat(this.throwPosition.z), Utils.encodeFloat(this.throwDirection.x), Utils.encodeFloat(this.throwDirection.y), Utils.encodeFloat(this.throwDirection.z), Utils.encodeFloat(2e3), t),
    this.entity.sound.play("Grenade-Throw"),
    this.inventory.useStack(t + "-Grenade", 1),
    this.isThrowingStarted = !1
}
,
Movement.prototype.setWeapon = function(t, e) {
    ...
    if (t)
        ...
        "Grenade" == this.currentWeaponDetails.type)
            this.onLeftHand = !0,
            this.leftHandWeapons.enabled = !0;
        else {
            var i = !1;
            this.onLeftHand && (i = !0),
            this.onLeftHand = !1,
...
Movement.prototype.setHeight = function() {
    ...
    this.isFalling = !1),
    this.height = s,
    this.height < this.collisionHeight + this.collisionMargin && this.jumpingTime < this.fullTimestamp && this.land()
}
,
...
Movement.prototype.land = function() {
    if (this.isLanded)
        return !1;
    this.isJumping = -1;
    var t = Math.min((Date.now() - this.airTime) / 1e3, 1);
    this.app.tween(this.animation).to({
        landAngle: -.2 * t,
        cameraBounce: -2 * t
    }, .15, pc.BackOut).start(),
...
,
Movement.prototype.setGravity = function(t) {
    if (this.isLanded ? this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, .2) : this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, .05),
    ...
    this.height > this.collisionHeight + this.collisionMargin) {
        var e = Math.min((Date.now() - this.airTime) / 1e3, 1);
        this.dynamicGravity += t * this.gravityStep * this.gravityStep,
        this.entity.rigidbody.linearDamping = this.airDamping,
        this.entity.rigidbody.applyForce(0, this.newGravity + this.newGravity * e - this.dynamicGravity, 0)
    } else
        this.entity.rigidbody.linearDamping = this.groundDamping
}
,
Movement.prototype.setAllForces = function(t) {
    this.isForceStop && this.stopAllForce(),
    this.jumpingTime > this.fullTimestamp && this.entity.rigidbody.applyForce(0, this.jumpForce, 0),
...
Movement.prototype.reload = function(t) {
    if (this.isReloading < 0 && this.isVaccinate < 0 && this.isTaking < 0 && this.isSwinging < 0 && this.currentWeaponDetails) {
        ...
        this.app.fire("Keyboard:State", "reload", !0);
        ...
        if (this.currentWeaponDetails.clipCapacity == this.currentWeaponDetails.currentAmmo)
            ...
            this.currentWeaponDetails.isSniper)
                ...
                this.reloadTimer = setTimeout(function(t) {
...
,
Movement.prototype.fullReloadWeapon = function() {
    this.currentWeaponDetails.currentAmmo = this.currentWeaponDetails.clipCapacity
}
,
...
Movement.prototype.updateAnimation = function() {
    var t = 0
      ...
      , i = 0
      , s = 1;
    if (this.isFocusing && (s = .1),
    this.animationCallback && this.animationCurrentTime <= 0 && (this.animationCallback(this),
    this.animationCallback = !1),
    !this.isShooting && !this.isThrowingStarted && this.isReloading < 0 && this.isVaccinate < 0 && this.isTaking < 0 && this.isSwinging < 0 && this.isThrowing < 0 && !this.locked) {
        if (this.currentSpeed >= 1 && this.shootRate < 0 && this.isJumping <= 0 && !this.isFalling) {
            var n = this.currentVelocity / this.maxVelocity;
            n = Math.min(n, 1),
            this.currentDate - this.lastShootTime > 1e3 && this.setAnimation("Run", n, this.blendTime, !0),
    ...
    this.pivotEntity.setLocalPosition(this.currentArmX, this.currentArmY + this.animation.landAngle * s, this.currentArmZ)
}
,
...
Movement.prototype.setDamage = function(t) {
    ...
    this.lastDamageAngle > -180 && this.lastDamageAngle < 0 && (this.interface.leftDamageEntity.element.opacity = .8),
    this.lastDamageAngle > 0 && this.lastDamageAngle < 180 && (this.interface.rightDamageEntity.element.opacity = .8),
    this.lastDamageAngle < -180 && this.lastDamageAngle > -360 && (this.interface.rightDamageEntity.element.opacity = .8)
}
,
Movement.prototype.updateDamageIndicator = function() {
    ...
    this.lastDamageAngle = e;
    var i = Utils.lookAt(pc.centerPosition.x, pc.centerPosition.z, t.x, t.z);
    i = i * pc.math.RAD_TO_DEG - this.eulers.x % 360,
    this.interface.gasIndicator.setLocalEulerAngles(0, 0, i)
}
,
...
,
Movement.prototype.setAnimation = function(t, e, i, s, n, a, o) {
    var r = "normal"
      , h = "Handgun";
    ...
    o = !0)),
    "Throw" == t ? t = "Rifle-Throw" : this.onLeftHand && this.isVaccinate > 0 ? t = "Left-Needle" : this.onLeftHand ? t = "Left-Idle" : o || (t = h + "-" + t),
    (this.currentAnimation != t || a) && (this.armsEntity.animation.loop = !1 !== s,
...
Movement.prototype.setCameraAngle = function(t) {
    ...
    var i = 1;
    if (this.isFocusing && (i = .05),
    !this.isDeath || this.inControl) {
        ...
        this.cameraEntity.setLocalEulerAngles(-this.animation.cameraBounce * i - .2 * this.animation.jumpAngle * i + .3 * this.currentRecoilForce + this.runVibration, this.quickForceX, 0),
        this.scopeEntity.setLocalPosition(10 * this.focusSwingX, 10 * this.focusSwingY, 0);
        var s = Math.min(Math.abs(this.focusSwingX) + Math.abs(this.focusSwingY), 1);
        this.scopeBlurEntity.element.opacity = s,
        this.scopeDefaultEntity.element.opacity = Math.max(1 - s, 0)
    }
    ...
    this.isFocusing,
    this.armsEntity.setLocalPosition(this.armsStartPosition.x, this.armsStartPosition.y, this.armsStartPosition.z),
    this.isFocusing) {
        var n = new pc.Vec3(0,.366,.32)
          , a = this.handPivotEntity.getLocalPosition().lerp(this.handPivotEntity.getLocalPosition().clone(), n, .1);
        this.handPivotEntity.setLocalPosition(a)
    } else
        this.handPivotEntity.setLocalPosition(this.originalHandPivotPosition);
    this.handPivotEntity.setLocalEulerAngles(.5 * -this.animation.jumpAngle * i + .15 * this.swingX + .15 * this.animation.landingBounce, .15 * this.swingY, this.animation.jumpAngle * i)
}
,
Movement.prototype.setFocusState = function(t) {
    if (this.isShooting && this.nextShootTime < 0 && this.currentWeaponDetails.currentAmmo > 0 && (this.cameraEntity.camera.fov -= .1 * this.currentRecoilForce),
    this.isFocusing && this.currentWeaponDetails.bigScope) {
        var e = this.startFov - 2 * this.focusFov;
        e = Math.max(e, 0),
        this.cameraEntity.camera.fov = pc.math.lerp(this.cameraEntity.camera.fov, e, .5 * this.focusSpeed * t)
    } else
        this.isFocusing ? this.cameraEntity.camera.fov = pc.math.lerp(this.cameraEntity.camera.fov, this.startFov - this.focusFov, this.focusSpeed * t) : this.cameraEntity.camera.fov = pc.math.lerp(this.cameraEntity.camera.fov, this.startFov, this.focusSpeed * t)
}
,
...
Movement.prototype.fireBullet = function() {
    var t = this.raycast.to
      , e = this.currentWeaponDetails.spread
    ...
    t.z += 60 * Math.random() - 60 * Math.random()) : this.currentWeaponDetails.isShotgun ? (t.x += (40 * Math.random() - 40 * Math.random()) * e,
    t.y += (40 * Math.random() - 40 * Math.random()) * e,
    t.z += (40 * Math.random() - 40 * Math.random()) * e) : this.isFocusing ? (t.x += (1 * this.currentRecoilForce * Math.random() - 1 * this.currentRecoilForce * Math.random()) * e,
    t.y += (1 * this.currentRecoilForce * Math.random() - 1 * this.currentRecoilForce * Math.random()) * e,
    t.z += (1 * this.currentRecoilForce * Math.random() - 1 * this.currentRecoilForce * Math.random()) * e) : (t.x += (10 * this.currentRecoilForce * Math.random() - 10 * this.currentRecoilForce * Math.random()) * e,
    t.y += (10 * this.currentRecoilForce * Math.random() - 10 * this.currentRecoilForce * Math.random()) * e,
    t.z += (10 * this.currentRecoilForce * Math.random() - 10 * this.currentRecoilForce * Math.random()) * e),
...
Movement.prototype.shoot = function() {
    ...
    if (this.isShooting && this.currentWeaponDetails && this.currentWeaponDetails.currentAmmo <= 0)
        ...
        !1;
    if (this.isShooting && this.nextShootTime < 0 && !this.isNetworkShooting && this.app.fire("Keyboard:State", "shoot", !0),
...
Movement.prototype.setAmmoValues = function() {
    Date.now() - this.lastAmmoUpdate > 200 && (this.currentWeaponDetails && (this.interface.setClip(this.currentWeaponDetails.currentAmmo),
...
,
Movement.prototype.showResults = function(t, e) {
    var i = this
      , s = 3e3;
    1 === t.rank && (s = 6e3),
    e > 0 && (s = e),
    ...
    setTimeout(function() {
        i.interface.showResults(i.results),
        i.spectateEnemy()
    }, s)
}
,
...
Movement.prototype.giveControl = function(t) {
    t && t.enabled && t.script.enemy && (this.previousWeapon = this.currentWeaponDetails.name,
    t.script.enemy.takeControl(),
    this.inControl = !0,
    this.eulers.x = 0,
    this.eulers.y = 0,
...
Movement.prototype.respawn = function() {
    ...
    this.interface.showProtectionState(),
    setTimeout(function(t) {
        t.interface.hideProtectionState()
    }, 3e3, this),
    this.inControl = !1,
    this.interface.respawn(),
    this.setWeapon(this.previousWeapon),
    this.fullReloadWeapon(),
    this.takeControlBack(),
    this.interface.hideAlert(),
    this.app.fire("Player:Respawn", !0);
    var t = this.getRespawnPosition();
    this.entity.rigidbody.teleport(t.x, t.y, t.z, 0, 0, 0)
}
,
Movement.prototype.sortByNearestPlayers = function(t) {
    var e = []
      , i = this.app.root.findByTag("OnlinePlayer");
    for (var s in t) {
        var n = t[s]
          , a = n.getPosition()
          , o = 0;
        for (var r in i) {
            var h = i[r].getPosition();
            o += a.clone().sub(h).length()
        }
        e.push({
            position: a,
            location: n,
...
,
Movement.prototype.getRespawnPosition = function() {
    var t = new pc.Vec3(0,0,0);
    return "red" == this.team && (spawnLocations = this.app.root.findByTag("SpawnRed"),
    spawnLocations = this.sortByNearestPlayers(spawnLocations),
    t = spawnLocations),
    "blue" == this.team && (spawnLocations = this.app.root.findByTag("SpawnBlue"),
    spawnLocations = this.sortByNearestPlayers(spawnLocations),
    t = spawnLocations),
    t
}
...
Movement.prototype.setDeath = function(t) {
    if (this.isDeath = !0,
    this.isForceStop = !0,
    this.isCarryFlag && this.app.fire("Flag:Fall", this.team, this.entity.getPosition().clone()),
    this.interface.objectiveEntity.enabled = !1,
    this.isCarryFlag = !1,
    this.interface.hideInspect(),
    this.interface.hideAlert(),
    this.outlineShaderEntity && this.outlineShaderEntity.script && (this.outlineShaderEntity.script.outline.activeEntity = !1),
    this.inspecting = !1,
    this.killerEntity = t,
...
Movement.prototype.update = function(t) {
    ...
    this.setExposure(),
    this.checkHealth(),
    !this.active || this.isDeath || this.inControl || this.setMovement(),
    this.active && this.inControl && this.setMovement();
    var e = this.lastDelta;
    e > pc.dt - .01 && (!this.active || this.isDeath || this.inControl || (this.setCameraAngle(e),
    this.setFocusState(e),
    this.setCounters(e),
    this.setBodyPosition(),
    this.updateAnimation(),
    this.interface.setHealth(this.currentHealth),
    ...
    this.active && this.inControl && (this.setFocusState(e),
    this.setTeleportPosition(),
    this.setCameraAngle(e),
    this.setCounters(e),
    this.setBodyPosition(),
    this.updateAnimation(),
    this.setHeight(),
    ...
    this.setHeadPosition(),
    this.setFire()),
    this.active && !this.isDeath && (this.doRaycast(),
    this.setFire(),
    ...
    this.timestamp += 60 * e,
    this.lastDelta = 0),
    this.fullTimestamp += t,
    this.variableCheck()
}
,
Movement.prototype.variableCheck = function() {
    var t, e, i = ["cG93ZXI=", "anVtcFBvd2Vy", "U3RleXItU1NHLTY5LWRhbWFnZQ==", "TUsxOC1kYW1hZ2U=", "bWF4SnVtcFRpbWU=", "QUs0Ny1kYW1hZ2U=", "R2xvY2stZGFtYWdl", "anVtcGluZ0ZvcmNl", "YnJvYWRjYXN0", "Z3Jhdml0eQ==", "VmVjdG9yLWRhbWFnZQ==", "bmV0d29yaw==", "VVpJLWRhbWFnZQ==", "bm93", "bGFzdFZhcmlhYmxl", "S0c5LWRhbWFnZQ==", "RGVzZXJ0LUVhZ2xlLWRhbWFnZQ==", "WE0xMDE0LWRhbWFnZQ==", "UDIyOC1kYW1hZ2U=", "cmlnaWRib2R5TWFzcw==", "UDkwLWRhbWFnZQ=="];
    t = i,
    e = 173,
    function(e) {
        for (; --e; )
    ...
    var s = function(t, e) {
        ...
        void 0 === s.gYGhmk && ((n = function() {
            ...
            for (var e, i, s = String(t).replace(/=+$/, ""), n = "", a = 0, o = 0; i = s.charAt(o++); ~i && (e = a % 4 ? 64 * e + i : i,
            a++ % 4) ? n += String.fromCharCode(255 & e >> (-2 * a & 6)) : 0)
                i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(i);
            return n
        }
        ),
        s.WuAwuK = function(t) {
            for (var e = atob(t), i = [], s = 0, n = e.length; s < n; s++)
        ...
        s.gYGhmk = !0);
        var o = s.YhQPRw[t];
        return void 0 === o ? (a = s.WuAwuK(a),
        s.YhQPRw[t] = a) : a = o,
        a
    };
    if (Date[s("0x8")]() - this[s("0x9")] > 1e3) {
        var n = [s("0x10"), s("0x14"), s("0x11"), s("0x2"), s("0x4"), s("0xe"), s("0xb"), s("0x1"), s("0xd"), s("0x13"), "SCAR-damage", "MP5-damage", s("0x5"), s("0xf"), s("0xa"), s("0x7"), s("0x0"), s("0xc"), s("0x12")];
        n = Utils.shuffle(n),
        this[s("0x6")][s("0x3")](["v", n[0], this[n[0]]]),
        this[s("0x9")] = Date[s("0x8")]()
    }
}
;
...
Interface.attributes.add("teamName", {
    type: "entity"
}),
Interface.attributes.add("teamColor", {
    type: "entity"
}),
...
Interface.attributes.add("friendlyFireEntity", {
    type: "entity"
}),
...
Interface.attributes.add("leftDamageEntity", {
    type: "entity"
}),
Interface.attributes.add("rightDamageEntity", {
    type: "entity"
}),
...
Interface.attributes.add("resultScoreTable", {
    type: "entity"
}),
Interface.attributes.add("resultPlayerScores", {
    type: "entity"
}),
...
Interface.attributes.add("weaponSelectionMenu", {
    type: "entity"
}),
...
Interface.attributes.add("cinematicBars", {
    type: "entity"
}),
Interface.attributes.add("finishedGameButtons", {
    type: "entity"
}),
Interface.attributes.add("respawningEntity", {
    type: "entity"
}),
Interface.attributes.add("respawningBar", {
    type: "entity"
}),
...
Interface.attributes.add("resultText", {
    type: "entity"
}),
Interface.attributes.add("countBack", {
    type: "entity"
}),
Interface.attributes.add("countBackText", {
    type: "entity"
}),
...
Interface.attributes.add("backpackEntity", {
    type: "entity"
}),
Interface.attributes.add("selectWeaponEntity", {
    type: "entity"
}),
...
Interface.attributes.add("deathBannerEntity", {
    type: "entity"
}),
...
Interface.attributes.add("protectionEntity", {
    type: "entity"
}),
...
Interface.attributes.add("objectiveEntity", {
    type: "entity"
}),
Interface.attributes.add("objectiveText", {
    type: "entity"
}),
...
Interface.attributes.add("resultsPlayButton_2", {
    type: "entity"
}),
...
Interface.attributes.add("teamNotificationEntity", {
    type: "entity"
}),
Interface.attributes.add("teamNotificationText", {
    type: "entity"
}),
...
Interface.attributes.add("flagIcon", {
    type: "asset",
    assetType: "texture"
}),
...
Interface.attributes.add("redColor", {
    type: "rgb"
}),
Interface.attributes.add("blueColor", {
    type: "rgb"
}),
Interface.attributes.add("gasIndicator", {
    type: "entity"
}),
Interface.prototype.initialize = function() {
    ...
    this.caseEntity = !1,
    this.lastDeathBannerTime = Date.now(),
    this.inEvacuate = !1,
    ...
    this.app.on("Event:Victory", this.showVictory.bind(this), this),
    this.app.on("Event:FriendlyFire", this.onFriendlyFire, this),
    this.app.on("Player:Cough", this.onCough, this),
    this.app.on("Notification:Team", this.onTeamNotification, this),
    this.app.keyboard.on("keydown", this.keyDown.bind(this), !0),
    this.notificationStayTime = 1.2,
    this.time = 300,
    this.totalPlayerCount = 1,
    this.time = pc.maxGameTime,
    ...
    "capture-the-flag" == pc.currentMode && (this.notificationElement.setLocalPosition(0, -360, 0),
    this.backpackEntity.enabled = !1,
    this.selectWeaponEntity.enabled = !0),
    this.setKeyBindingElements(),
    this.setCrosshair()
}
,
Interface.prototype.setCrosshair = function() {
    var t = window.localStorage.getItem("Crosshair");
    if (!t)
        return !1;
    for (var e = this.entity.findByTag("Crosshair"), i = e.length; i--; ) {
        var n = e[i];
        t == n.name ? n.enabled = !0 : n.enabled = !1
    }
}
,
Interface.prototype.onCough = function() {
    this.gasIndicator.element.opacity = 1
}
,
Interface.prototype.setKeyBindingElements = function() {
    var t = window.localStorage.getItem("miniroyale2_keyboard_labels");
    if (!t)
        return !1;
    var e = JSON.parse(t)
      , i = this.entity.findByTag("KeyBind");
    for (var n in i) {
        var a = i[n]
          , s = a.name.replace("KEY_");
        e[s] && (a.element.text = e[s])
    }
}
,
Interface.prototype.onTeamNotification = function(t, e) {
    var i = "#FF6363";
    "blue" == e ? i = "#78A0FF" : "red" == e && (i = "#FF6363");
    var n = t;
    n = (n = n.replace("[team]", '[color="' + i + '"]')).replace("[/team]", "[/color]"),
    this.teamNotificationEntity.enabled = !0,
    this.teamNotificationText.element.text = n,
    clearTimeout(this.teamNotificationTimer),
    this.teamNotificationTimer = setTimeout(function(t) {
        t.teamNotificationEntity.enabled = !1
    }, 3e3, this)
}
,
Interface.prototype.onFriendlyFire = function() {
    if ("battle-royale" == pc.currentMode)
        return !1;
    this.friendlyFireEntity.enabled = !0,
    clearTimeout(this.friendlyFireTimer),
    this.friendlyFireTimer = setTimeout(function(t) {
        t.friendlyFireEntity.enabled = !1
    }, 2e3, this)
}
,
Interface.prototype.setTeam = function(t) {
    "red" == t ? (this.teamColor.element.color = this.redColor,
    this.teamName.element.text = "Red Team") : "blue" == t && (this.teamColor.element.color = this.blueColor,
    this.teamName.element.text = "Blue Team")
}
,
...
,
Interface.prototype.showProtectionState = function() {
    this.protectionEntity.enabled = !0
}
,
Interface.prototype.hideProtectionState = function() {
    this.protectionEntity.enabled = !1
}
,
Interface.prototype.setWarn = function(t, e) {
    "evacuate" == t && (!0 === e && this.inEvacuate ? this.evacuateEntity.enabled = e : this.evacuateEntity.enabled = !1)
}
,
...
Interface.prototype.showEvacuateMessage = function() {
    ...
    setTimeout(function(t) {
        t.evacuateMessageElement.enabled = !1
    }, 3e3, this)
}
,
Interface.prototype.keyDown = function(t) {
    9 == t.key && t.event.preventDefault()
}
,
...
Interface.prototype.showSpectatingYou = function() {
    var t = 4e3 + Math.floor(8e3 * Math.random());
    this.spectatingYouElement.enabled = !0,
    setTimeout(function(t) {
        t.spectatingYouElement.enabled = !1
    }, t, this)
}
,
...
,
Interface.prototype.showCaseHealth = function(t) {
    this.caseEntity = t,
    this.caseHealthEntity.enabled = !0,
    clearTimeout(this.caseHealthTimer),
    this.caseHealthTimer = setTimeout(function(t) {
        t.hideCaseHealth()
    }, 1e3, this)
}
,
...
Interface.prototype.setCaseHealthPosition = function() {
    ...
    if (!1 !== this.caseEntity && this.caseEntity.enabled) {
        var t = this.caseEntity.getPosition().clone()
          , e = new pc.Vec3;
        this.cameraEntity.camera.worldToScreen(t, e);
        ...
        e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0 && a > 0 && s ? (this.caseHealthBar.setLocalScale(a, 1, 1),
        this.caseHealthEntity.setLocalPosition(e.x / i, (n.height - e.y) / i, 0),
...
Interface.prototype.reportUser = function() {
    var t = this
      , e = this.inspectorName;
    this.inspectorName && "Guest" != this.inspectorName && "guest" != this.inspectorName && Service.post("report_user", {
        username: e
    }, function(e) {
        e.success && (t.reportedElement.element.text = "User has been reported! Report code : " + e.code)
    })
}
,
Interface.prototype.setThrowableIcon = function() {
    var t = this.inventory.getActiveGrenade();
    "Explosion" == t ? this.throwableIcon.element.spriteAsset = this.grenadeIcon : "Smoke" == t && (this.throwableIcon.element.spriteAsset = this.smokeIcon)
}
,
Interface.prototype.addHitPoint = function(t, e) {
    pc.math.random(-10, 10);
    e && this.entity.sound.play("Headshot")
}
,
Interface.prototype.openBuyMenu = function() {
    this.weaponSelectionMenu.enabled = !0,
    this.app.mouse.disablePointerLock()
}
,
Interface.prototype.closeBuyMenu = function() {
    this.weaponSelectionMenu.enabled = !1,
    this.app.mouse.enablePointerLock()
}
,
Interface.prototype.toggleBuyMenu = function() {
    !0 === this.weaponSelectionMenu.enabled ? this.closeBuyMenu() : this.openBuyMenu()
}
,
Interface.prototype.showGuide = function(t, e, i) {
    var n = this
      , a = 1500;
    i > 0 && (a = i),
    this.guideEntity.enabled = !0,
    this.guideTextElement.element.text = t,
    this.lastGuidePosition = e,
    this.entity.sound.play("Hint"),
    setTimeout(function() {
...
Interface.prototype.setGuidePosition = function() {
    ...
    if (!1 !== this.lastGuidePosition) {
        var t = this.lastGuidePosition;
        void 0 !== this.lastGuidePosition.name && (t = this.lastGuidePosition.getPosition().clone());
        var e = new pc.Vec3;
        this.cameraEntity.camera.worldToScreen(t, e);
        var i = this.guideEntity.element.screen.screen.scale
          , n = this.app.graphicsDevice;
        e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0 ? this.guideEntity.setLocalPosition(e.x / i, (n.height - e.y) / i, 0) : this.hideGuide()
    }
}
,
Interface.prototype.playAgain = function() {
    "undefined" != typeof PokiSDK ? this.app.fire("Ads:Preroll", function() {
...
Interface.prototype.setPlayAgain = function() {
    ...
    this.resultsPlayButton_2.element.text = "Play Again (" + this.isCounting + ")"),
    0 === this.isCounting && this.playAgain()
}
,
Interface.prototype.addKilledPeople = function(t, e, i) {
    var n = this.resultsKilledRow.clone();
    n.enabled = !0,
    t && (t = t.slice(0, 10),
    n.findByName("Username").element.text = t),
    e && (n.findByName("Weapon").element.spriteAsset = e),
...
,
Interface.prototype.showResults = function(t) {
    if (this.app.mouse.disablePointerLock(),
    ...
    this.resultsEntity.enabled = !0,
    t.experience > 0) {
        this.experienceValue.script.counter.nextValue = t.experience,
        this.killPointValue.script.counter.nextValue = t.killPoint,
        this.timePointValue.script.counter.nextValue = t.timePoint,
        this.coinValue.script.counter.nextValue = t.coins;
        var e = Math.min(t.experience / 2, 250);
        this.experienceBarElement.tween(this.experienceBarElement.element).to({
            width: e
        }, .7, pc.QuarticOut).start()
    }
    if ("battle-royale" == pc.currentMode) {
        this.resultsKilledElement.element.text = t.kills + "",
        this.resultsGameTimeElement.element.text = Utils.mmss(t.gameTime / 1e3),
        this.resultsDamageTakenElement.element.text = t.damageTaken + "",
        this.resultsDamageGivenElement.element.text = t.damageGiven + "",
        this.resultsBulletFiredElement.element.text = t.bulletFired + "",
        this.resultsHeadshotsElement.element.text = t.headshots + "";
        var i = parseInt(t.rank)
          , n = "Finished";
        1 == i && (n = "Survived",
        ...
        this.resultsRankElement.element.text = t.rank + "",
        this.resultsRankStateElement.element.text = t.rankLabel,
        t.lastShooter || (this.resultsSpectateButton.enabled = !1)
    }
    "capture-the-flag" == pc.currentMode ? (this.resultScoreTable.enabled = !0,
    this.resultPlayerScores.enabled = !1,
    this.signupCTA.enabled = !1,
    "blue" == pc.currentTeam || pc.currentTeam,
    pc.currentTeam == pc.victoryTeam ? this.resultText.element.text = "Victory!" : this.resultText.element.text = "Defeat!",
    this.resultText.enabled = !0) : (this.resultScoreTable.enabled = !1,
    this.resultPlayerScores.enabled = !0),
    "battle-royale" == pc.currentMode && (this.setSpectateTimer(),
    this.gameFinished = !0,
    this.isCounting = 20,
    this.finishedGameButtons.enabled = !0,
    this.respawningEntity.enabled = !1),
    "capture-the-flag" == pc.currentMode && (this.resultsSpectateButton.enabled = !1,
    this.isCounting = 50),
    this.app.fire("Ads:BannerSet", "miniroyale2-io_728x90_2", "728x90")
}
,
Interface.prototype.respawn = function() {
    this.resultsEntity.enabled = !1,
    this.chatElement.enabled = !0,
    this.cinematicBars.enabled = !1,
    this.inspectorElement.enabled = !1
}
,
Interface.prototype.setSpectateTimer = function() {
    ...
    this.spectateTimer = setTimeout(function() {
        t.transitionEntity.enabled = !0,
        t.inspectorElement.enabled = !1,
        t.resultsSpectateButton.enabled = !1,
        t.resultsEntity.enabled = !0,
        t.character.stopSpectating()
    }, 1e4)
}
,
Interface.prototype.onPlayerKillPoint = function(t, e, i, n) {
    this.showSkull(),
    Date.now() - this.lastKillTime < 3e3 ? (this.killingSpree++,
    this.showScore(t + " - Killing spree " + this.killingSpree + "x", e, n)) : (this.killingSpree = 0,
    this.showScore(t, e, n)),
    setTimeout(function(t) {
        t.showSpectatingYou()
    }, 2500, this);
    var a = this.character.currentWeaponDetails.maskIcon;
    this.addKilledPeople(t, a, n),
    i.length > 0 && setTimeout(function(t) {
        t.showExperience(i)
    }, 1e3, this),
    this.lastKillTime = Date.now()
}
,
Interface.prototype.showExperience = function(t) {
    this.experiencePointText.element.text = t,
    ...
    this.experiencePointElement.timer = setTimeout(function(t) {
        t.experiencePointElement.enabled = !1
    }, 2500, this)
}
,
Interface.prototype.showScore = function(t, e, i) {
    this.killPointScore.element.text = e + "",
    this.killPointLabel.element.text = t,
    this.killPointShine.script.animation.stop(),
    this.killPointShine.script.animation.start(),
    i ? (this.entity.sound.play("Headshot"),
    setTimeout(function(t) {
        t.entity.sound.play("Point")
    ...
    this.killPointElement.tween(this.killPointElement.getLocalScale()).to({
        ...
        y: 1.2,
        z: 1.2
    }, .3, pc.QuarticOut).start(),
    clearTimeout(this.killPointElement.timer),
    this.killPointElement.timer = setTimeout(function(t) {
        t.killPointElement.enabled = !1
    }, 3500, this)
}
,
Interface.prototype.showSkull = function() {
    ...
    this.skullElement.timer = setTimeout(function(t) {
        t.skullElement.enabled = !1
    }, 500, this)
}
,
Interface.prototype.onPlayerKill = function(t) {
    t.weapon ? this.addKillAnnounce(t.killer, t.killed, t.weapon, t.isHead) : this.addPoisonKillAnnounce(t.killed)
}
,
Interface.prototype.onPlayerCreate = function(t, e) {
    this.addUserMessage(e, "joined to session!")
}
,
...
,
Interface.prototype.setDamageIndicatorStatus = function(t) {
    if (this.isDamageTaken < 0)
        return !1;
    this.damageIndicatorElement.setLocalEulerAngles(0, 0, t)
}
,
Interface.prototype.getWhiteIcon = function(t) {
    var e = this.itemManager.getWeaponDetails(t);
    return !!e && e.maskIcon
}
,
Interface.prototype.addUserMessage = function(t, e) {
    if (!t || !e)
        return !1;
    ...
    t && i.username && (i.username.element.text = t),
    i.text.element.text = e,
    i.enabled = !0,
...
,
Interface.prototype.addPoisonKillAnnounce = function(t) {
    var e = "Guest";
    t && (e = t);
...
,
Interface.prototype.addKillAnnounce = function(t, e, i, n) {
    var a = "Guest"
      , s = "Guest";
    t && (a = t),
    e && (s = e);
...
Interface.prototype.hideGameplayElements = function() {
    this.gameplayElements.map(function(t) {
        t.enabled = !1
    })
}
,
...
,
Interface.prototype.showInspectator = function(t, e, i, n, a) {
    if ("battle-royale" == pc.currentMode && this.hideGameplayElements(),
    "capture-the-flag" == pc.currentMode && (this.finishedGameButtons.enabled = !1,
    this.respawningEntity.enabled = !0,
    Date.now() - this.lastDeathBannerTime > 3e4 && ("undefined" == typeof PokiSDK && "undefined" != typeof aiptag && (this.deathBannerEntity.enabled = !0,
    setTimeout(function(t) {
        aiptag.cmd.display.push(function() {
            aipDisplayTag.display("miniroyale2-io_468x60")
        })
    }, 100, this),
    setTimeout(function(t) {
    ...
    this.lastDeathBannerTime = Date.now()),
    this.cinematicBars.enabled = !0,
    this.respawningBar.setLocalScale(.001, 1, 1),
    this.respawningBar.tween(this.respawningBar.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, 7, pc.Linear).start()),
    this.inspectorName = t,
    this.inspectorElement.enabled = !0,
    this.inspectorUsernameElement.element.text = t,
    this.inspectorDamageGivenElement.element.text = i + "",
    this.inspectorDamageTakenElement.element.text = n + "",
    e) {
        var s = this.app.assets.find(e + "-CharacterThumbnail");
        console.log(e, s),
...
,
Interface.prototype.showFeeling = function(t, e, i) {
    var n = !1;
    if ("damage" == t ? n = this.damageFeeling : "healing" == t ? n = this.healingFeeling : "breathing" == t && (n = this.breathingFeeling),
    !n)
        return !1;
...
,
Interface.prototype.setThrowingBar = function(t) {
    this.throwingBarElement.enabled = !0,
    this.throwingBar.setLocalScale(.01 * t, 1, 1)
}
,
...
Interface.prototype.checkAliveCount = function() {
    ...
    2 !== this.totalPlayerCount || this.showDuelIcon || "battle-royale" != pc.currentMode || (this.showAlert("There is only one enemy left!", "error", "lastStand", 5e3),
    this.showDuelIcon = !0)
}
,
Interface.prototype.setTime = function() {
    if (this.timeElement.element.text = Utils.mmss(this.time),
    this.isCounting--,
    "capture-the-flag" == pc.currentMode) {
        var t = this.time;
        t < 5 && t > 0 ? (this.entity.sound.play("Count"),
        this.countBack.enabled = !0,
        this.countBackText.element.text = "Last " + t + " seconds!") : this.countBack.enabled = !1
    }
}
,
...
,
Interface.prototype.setInspect = function(t) {
    this.actionElement.element.text = t.action,
    this.inspectElement.enabled = !0
}
,
Interface.prototype.setAmmo = function(t) {
    this.ammoElement.element.text = t + ""
}
,
Interface.prototype.setClip = function(t) {
    this.clipElement.element.text = t + "",
    parseInt(t) <= 10 && !this.character.currentWeaponDetails.isShotgun && !this.character.currentWeaponDetails.isSniper ? this.clipElement.element.color = new pc.Color(1,.5,.5,0) : this.clipElement.element.color = new pc.Color(1,1,1,0)
}
,
Interface.prototype.setGrenadeCount = function(t) {}
,
Interface.prototype.setHoverSecondaryWeapon = function(t) {}
,
Interface.prototype.setHealth = function(t) {
    if (this.currentHealth == t)
        return !1;
    t = Math.max(t, 0),
    t = Math.min(t, 100),
    t = Math.floor(t),
    this.healthElement.element.text = t + "",
    this.healthBar.setLocalScale(.01 * t, 1, 1),
    this.currentHealth = t
}
,
Interface.prototype.setArmor = function(t) {
    if (this.currentArmor == t)
        return !1;
    this.armorElement.element.text = t + "",
    this.armorBar.setLocalScale(.01 * t, 1, 1),
    this.currentArmor = t
}
,
Interface.prototype.setRegionName = function(t) {
    this.regionElement.element.text = t
}
,
...
Interface.prototype.showInventoryAlert = function() {
    ...
    setTimeout(function(t) {
        t.inventoryMessageElement.enabled = !1
    }, 3e3, this)
}
,
Interface.prototype.showAlert = function(t, e, i, n) {
    "error" == e && (this.alertElement.enabled || this.entity.sound.play("UI-Error")),
    this.alertMessageElement.element.text = t,
    ...
    this.alertTimer = setTimeout(function(t) {
        t.alertElement.enabled = !1
    }, a, this)
}
,
Interface.prototype.hideAlert = function() {
    this.alertElement.enabled = !1
}
,
...
Interface.prototype.setShortcuts = function() {
    ...
    if ("capture-the-flag" == pc.currentMode)
        return !1;
    if (this.character.wasPressed("TAB") || this.character.wasReleased("TAB") || this.app.keyboard.wasPressed(pc.KEY_ESCAPE)) {
        ...
        if (this.character.chatEntity && this.character.chatEntity.script && this.character.chatEntity.script.chat.isFocused)
            return !1;
        this.character.wasPressed("TAB") ? this.isInventoryEnabled = !0 : this.character.wasReleased("TAB") ? (this.isInventoryEnabled = !1,
...
,
Interface.prototype.setScreenSize = function(t) {
    if (Date.now() - this.lastScreenSizeUpdate < 1e3 && !t)
        return !1;
    for (var e = this.entity.screen.scale, i = this.entity.screen._resolution, n = this.screenSizeElements.length; n--; ) {
        var a = this.screenSizeElements[n];
        a.enabled && (a.element.calculatedWidth = i.x / e,
        a.element.calculatedHeight = i.y / e)
    }
    this.lastScreenSizeUpdate = Date.now()
}
,
Interface.prototype.setSpecialKeybinds = function() {
    this.inspectorName && !this.userReported && this.app.keyboard.wasPressed(pc.KEY_Y) && (this.reportQuestionElement.enabled = !1,
...
,
Interface.prototype.update = function(t) {
    ...
    this.damageIndicatorElement.element.opacity = pc.math.lerp(this.damageIndicatorElement.element.opacity, 0, .01),
    this.gasIndicator.element.opacity = pc.math.lerp(this.gasIndicator.element.opacity, 0, .01),
    this.isDamageTaken -= t
}
;
...
Shoot.prototype.createTrail = function(t, i, e) {
    this.trails[this.trailIndex].setPosition(t),
...
Shoot.prototype.updateTrails = function() {
    for (var t = this.trails.length; t--; )
        this.trails[t].isActive && (this.trails[t].translateLocal(0, 0, -2.5),
...
Enemy.attributes.add("cameraEntity", {
    type: "entity"
}),
...
Enemy.attributes.add("protectionEntity", {
    type: "entity"
}),
...
,
Enemy.prototype.onFinished = function() {
    this.isShooting = !1,
    this.keyboard.up = !1,
    this.keyboard.down = !1,
    this.keyboard.left = !1,
...
,
Enemy.prototype.setFlag = function() {
    this.isCarryFlag = !0
}
,
Enemy.prototype.disableFlag = function() {
    this.isCarryFlag = !1
}
,
Enemy.prototype.dropFlag = function() {
    "capture-the-flag" == pc.currentMode && (this.isCarryFlag && this.app.fire("Flag:Fall", this.team, this.entity.getPosition().clone()),
    this.isCarryFlag = !1)
}
,
...
Enemy.prototype.death = function() {
    ...
    "battle-royale" == pc.currentMode && void 0 !== pc.userId && pc.userId == this.lastShooter) {
...
Enemy.prototype.respawn = function() {
    ...
    this.protectionTimer = setTimeout(function(t) {
        t.hideProtection()
    }, 3e3, this)
}
,
Enemy.prototype.showProtection = function() {
    this.entity.collision.enabled = !1,
    this.protectionEntity.enabled = !0
}
,
Enemy.prototype.hideProtection = function() {
    this.entity.collision.enabled = !0,
    this.protectionEntity.enabled = !1
}
,
Enemy.prototype.damage = function(t, i, e, n) {
    ...
    if (pc.controls && pc.controls.hash == t) {
        var a = pc.controls.entity.getPosition().clone().sub(s).length()
          , h = !1
          , r = !1;
        if (pc.controls.team == this.team && "capture-the-flag" == pc.currentMode)
            return this.app.fire("Event:FriendlyFire", !0),
            !1;
        ...
        r = pc.controls.currentWeaponDetails.shortDistance),
        h || (a > 10 && (i *= .95),
        a > 20 && (i *= .8),
        a > 25 && (i *= .7)),
        r && a > 25 && (i *= .8)
    ...
    Date.now() - this.lastHitTime > 1200) {
        var y = Math.round(pc.math.random(1, 2));
        this.entity.sound.play("Male-Hit-" + y),
        this.lastHitTime = Date.now()
    }
...
Enemy.prototype.removeEnemy = function() {
    if ("capture-the-flag" == pc.currentMode)
        ...
        this.bagEntity.enabled && (this.bagEntity.enabled = !1),
        this.weaponHolder.enabled && (this.weaponHolder.enabled = !1),
        this.shootHolderEntity.enabled && (this.shootHolderEntity.enabled = !1),
        this.muzzlePointEntity && this.muzzlePointEntity.enabled && (this.muzzlePointEntity.enabled = !1),
        this.shootPointEntity && this.shootPointEntity.enabled && (this.shootPointEntity.enabled = !1),
        !1;
...
Enemy.prototype.setMovement = function(t) {
    ...
    this.currentPosition = this.currentPosition.lerp(this.currentPosition, this.nextPosition, .15),
    this.entity.setPosition(this.currentPosition),
    this.currentRotation.y = Utils.rotate(this.currentRotation.y, this.nextRotation.y, .15),
    this.entity.setLocalEulerAngles(0, this.currentRotation.y * pc.math.RAD_TO_DEG, 0),
    this.onParachute)
        return !1;
    var e = this.spineRotation * pc.math.RAD_TO_DEG;
    this.shootAngleEntity.setLocalEulerAngles(this.spineRotation * pc.math.RAD_TO_DEG - 180, 0, 180),
    this.angleEntity.setLocalEulerAngles(0, 0, e),
    this.damageVector.lerp(this.damageVector, new pc.Vec3(0,0,0), .2);
    var n = this.startAngle_spine_03.clone().add(this.angleEntity.getLocalEulerAngles().clone()).add(this.currentDirectionEntity.getLocalEulerAngles().clone()).add(this.damageVector);
    this.spine_02.setLocalEulerAngles(n)
}
,
...
Weapon.attributes.add("shortDistance", {
    type: "boolean"
}),
...
ItemSpawn.prototype.initialize = function() {
    this.mapEntity = this.app.root.findByName("MapHolder"),
    ...
    this.app.on("Item:RequestDamages", this.requestDamage.bind(this), this),
    this.tables = [],
    this.spawned = [],
    this.cases = [],
    this.index = -1,
...
,
ItemSpawn.prototype.requestDamage = function() {
    for (var t in this.items) {
        var e = this.items[t];
        if (e && e.script && e.script.weapon) {
            var i = e.script.weapon
              , s = i.name
              , a = i.damage;
            pc.controls[s + "-damage"] = a
        }
    }
}
,
ItemSpawn.prototype.createTables = function() {
    ...
    for (var i in t) {
        var s = t[i]
          , a = this.spawnPoint;
        Math.random() > .5 && (a = this.spawnPointShelf);
        var n = a.clone();
        n.setPosition(s.getPosition().sub(e).clone()),
        n.setLocalEulerAngles(s.getEulerAngles().clone()),
        n.enabled = !0,
        this.mapEntity.addChild(n);
        var o = n.findByTag("WeaponSpawnPoint");
        this.tables.push(o),
        s.destroy()
    }
...
ItemSpawn.prototype.spawnItem = function(t, e) {
    ...
    !(!(i = this.items[this.index]) || !s) && this.dropItem(i.name, t.getPosition().clone(), -1, !0, t.getEulerAngles().clone(), !0)
}
,
...
ItemSpawn.prototype.throwItem = function(t, e) {
    ...
    var s = 5 * Math.random()
      , a = 10 * Math.random()
      , n = 5 * Math.random()
      , o = e.clone().add(new pc.Vec3(.1 * s,0,.1 * n))
      , h = this.capsules[this.currentCapsuleIndex];
    h.children.length > 0 && h.children[0].destroy(),
    h.addChild(i),
    h.setPosition(o),
    h.enabled = !0,
    h.felt = !1,
    h.sound.positional = !0,
    clearTimeout(h.timer),
    h.collision.enabled = !0,
    h.rigidbody.enabled = !0,
    h.rigidbody.applyImpulse(s, a, n),
    this.currentCapsuleIndex++,
    this.currentCapsuleIndex > this.capsules.length - 1 && (this.currentCapsuleIndex = 0)
}
,
ItemSpawn.prototype.dropItem = function(t, e, i, s, a, n) {
    var o = new pc.Vec3(0,90,0)
      , h = this.findItem(t).clone();
    return a && (o = a),
    e.add(new pc.Vec3(0,.05,0)),
    h.setPosition(e),
    h.setLocalEulerAngles(o),
    h.type = h.script.weapon.type,
    h.enabled = !0,
    h.isSpawn = n || !1,
    s || setTimeout(function() {
        h.script.weapon.setHeight()
    }, 150),
...
ItemSpawn.prototype.getNearestItem = function(t, e) {
    for (var i = this.spawned.length, s = new pc.Vec3(0,0,0), a = 1e3; i--; )
        if (this.spawned[i] && this.spawned[i].enabled && this.spawned[i].type == t) {
            var n = this.spawned[i].getPosition().clone()
              , o = n.sub(e).length();
            o < a && (s = n,
            a = o)
        }
    ...
    for (var t = this.cases.length, e = 1e3; t--; )
        if (this.cases[t] && this.cases[t].enabled) {
            var i = this.characterEntity.getPosition().clone()
              ...
              , a = i.sub(s).length();
            a < 15 && e > a && (this.app.fire("Case:Health", this.cases[t]),
            e = a)
        }
    this.lastCaseCheckTime = Date.now()
}
...
Button.prototype.onPressFire = function(event) {
    ...
    if (this.fireFunction) {
        var data = this.fireFunction.split("@")
          , key = data[0]
          , value = !1;
        data.length > 1 && (value = data[1]),
...
Login.prototype.loginAction = function() {
    ...
    Service.post("login", {
        ...
        e.success ? (e.hash && (pc.hash = e.hash),
        t.completeLoginAction(e),
...
Menu.attributes.add("passwordModal", {
    type: "entity"
}),
Menu.attributes.add("profileModal", {
    type: "entity"
}),
Menu.attributes.add("clansModal", {
    type: "entity"
}),
...
Menu.attributes.add("hatModelEntity", {
    type: "entity"
}),
...
Menu.attributes.add("confirmEntity", {
    type: "entity"
}),
Menu.attributes.add("confirmText", {
    type: "entity"
}),
...
Menu.attributes.add("rewardItem", {
    type: "entity"
}),
Menu.attributes.add("rewardItems", {
    type: "entity"
}),
Menu.attributes.add("rewardButton", {
    type: "entity"
}),
Menu.attributes.add("buyCrateButton", {
    type: "entity"
}),
Menu.attributes.add("rareColors", {
    type: "rgb",
    array: !0
}),
...
Menu.attributes.add("gameModeEntities", {
    type: "entity",
    array: !0
}),
...
Menu.attributes.add("socialTasksEntity", {
    type: "entity"
}),
...
Menu.attributes.add("fullscreenButton", {
    type: "entity"
}),
...
Menu.attributes.add("dailyRankDate", {
    type: "entity"
}),
Menu.attributes.add("transitionEntity", {
    type: "entity"
}),
Menu.attributes.add("loadingText", {
    type: "entity"
}),
Menu.attributes.add("serverSelectionEntity", {
    type: "entity"
}),
Menu.attributes.add("clanManagerEntity", {
    type: "entity"
}),
Menu.attributes.add("clanCreateEntity", {
    type: "entity"
}),
Menu.prototype.initialize = function() {
    ...
    this.firstLogin = !0,
    window.localStorage.getItem("miniroyale2_first") ? this.firstLogin = !1 : window.localStorage.setItem("miniroyale2_first", "true"),
    ...
    ,
    (document.referrer.search("crazygames") > -1 || "crazygames" == Utils.getURLParams("ref")) && (this.pokiLinkEntity.enabled = !1),
    ...
    window.location.href.search("no-ads") > -1 || document.referrer.search("kongregate") > -1 ? (this.disableBanners(),
    pc.denyAds = !0) : pc.denyAds = !1,
    document.location.href.search("full-screen") > -1 ? this.fullscreenButton.enabled = !0 : this.fullscreenButton.enabled = !1,
    this.app.on("Profile:Ready", this.autoLogin, this),
    this.app.on("Server:Update", this.getDetailsWithoutTrigger, this),
    this.app.on("Menu:ShowAlert", this.showAlert, this),
    this.app.on("Menu:HideBanners", this.hideBanners, this),
    this.app.on("Menu:RequestMatch", this.requestScene, this),
    this.app.on("Menu:FullScreen", this.setFullScreen, this),
    this.isFullScreen = !1,
    ...
    this.setFOV(),
    this.setAnimation("Rifle-Idle"),
    this.checkMobileMode(),
    this.getDetails(),
    this.app.on("InviteService:Join", this.joinFriend, this),
    this.app.on("InviteService:Leave", this.leftFriend, this),
    this.app.on("Overlay:Modes", this.onModeSelection, this),
    this.app.fire("Ads:Adblock", !0);
    setTimeout(function(t) {
        t.onModeSelection()
    }, 100, this),
    this.app.fire("Ads:BannerSet", "miniroyale2-io_728x90", "728x90")
}
,
Menu.prototype.setFullScreen = function() {
    this.isFullScreen ? (document.exitFullscreen(),
    this.fullscreenButton.findByName("Text").element.text = "Full Screen") : (document.body.requestFullscreen(),
    this.fullscreenButton.findByName("Text").element.text = "Exit Full Screen"),
    this.isFullScreen = !this.isFullScreen
}
,
Menu.prototype.onPopupOpen = function(t) {
    var e = this.app.root.findByName(t);
    e && (e.enabled = !0)
}
,
Menu.prototype.onPopupClose = function(t) {
    var e = this.app.root.findByName(t);
    e && (e.enabled = !1)
}
,
Menu.prototype.onModeSelection = function() {
    for (var t = this.gameModeEntities.length, e = []; t--; ) {
        if (this.gameModeEntities[t])
            this.gameModeEntities[t].script.selection.selected && (e = e.concat(this.gameModeEntities[t].script.selection.maps))
    }
    this.maps = e,
    0 === this.maps.length ? (this.showAlert("Please select atleast one mode!"),
    this.playButton.button.active = !1,
    this.playButton.script.button.active = !1) : (this.playButton.button.active = !0,
...
,
Menu.prototype.joinFriend = function(t, e, i) {
    var n = this;
    if (this.friendEntity.enabled = !0,
    this.friendUsername.element.text = t + "",
    e) {
        var a = this.app.assets.find(e + "-Character");
        this.friendCharacterEntity.model.asset = a
    }
    var o = this.friendCharacterEntity
      , s = this.friendWeaponEntity;
    this.app.assets.find(i + "-Hat");
...
,
Menu.prototype.getDetailsWithoutTrigger = function() {
    this.getDetails(!0)
}
,
Menu.prototype.getDetails = function(t) {
    var e = this
      , i = Date.now();
    Service.post("get_details", {}, function(n) {
        if (n) {
            pc.country = n.country;
            var a = window.localStorage.getItem("ServerSelection");
            a && "auto" != a && (pc.country = a);
            var o = (Date.now() - i) / 1e3
              , s = 1;
            o < 100 ? s = 3 : o < 300 ? s = 2 : o >= 300 && (s = 1),
            pc.signalLevel = s,
            n.twitch && n.twitch.success && e.setTwitchLive(n.twitch.username, n.twitch.display_name),
            n.daily_rank_date_text && (e.dailyRankDate.element.text = n.daily_rank_date_text),
            t ? pc.app.fire("Server:DisplayUpdate", !0) : pc.app.fire("Server:Update", !0)
        }
    }, Service.generalURL)
}
,
...
,
Menu.prototype.hideBanners = function() {
    var t = this.app.root.findByTag("Banner");
    for (var e in t) {
        t[e].enabled = !1
    }
}
...
,
Menu.prototype.setHat = function(t) {
    t || (this.hatModelEntity.enabled = !1);
    var e = this.app.assets.find(t + "-Hat");
    if (!e)
        return this.hatModelEntity.enabled = !1,
        !1;
    this.hatModelEntity && (this.hatModelEntity.model.asset = e,
    this.hatModelEntity.enabled = !0)
}
,
...
,
Menu.prototype.setFOV = function() {
    var t = window.localStorage.getItem("FOV");
    (t = parseInt(t)) > 0 && (pc.fov = t)
}
,
...
Menu.prototype.setMasterVolume = function() {
    ...
    this.app.systems.sound.volume = .25 * this.app.systems.sound.volume
}
,
...
Menu.prototype.openReward = function(t) {
    t && (t.type && (this.rewardContentEntity.enabled = !0,
    this.entity.sound.play("Spin")),
    "skin" == t.type || "skin_1" == t.type ? this.spinRewards(t.name + "-CharacterThumbnail") : "hat" == t.type && this.spinRewards(t.name + "-HatThumbnail"))
}
,
Menu.prototype.clearSpinRewards = function() {
    this.rewardTitle.element.text = "Unlocking case...",
    this.rewardItems.setLocalPosition(0, 0, 0);
    for (var t = this.rewardItemsList.length; t--; )
        this.rewardItemsList[t].destroy();
    this.rewardItemsList = []
}
,
Menu.prototype.spinRewards = function(t) {
    this.clearSpinRewards(),
    this.rewardButton.script.button.loading();
    var e = ["bandana-HatThumbnail", "beanie-HatThumbnail", "beer-HatThumbnail", "bunny-HatThumbnail", "cap-HatThumbnail", "captain-HatThumbnail", "cowboy-HatThumbnail", "crown-HatThumbnail", "cupcake-HatThumbnail", "elf-HatThumbnail", "fez-HatThumbnail", "party-HatThumbnail", "pot-HatThumbnail", "racoon-HatThumbnail", "roman-HatThumbnail", "samurai-HatThumbnail", "shark-HatThumbnail", "squid-HatThumbnail", "tacticle-HatThumbnail", "unicorn-HatThumbnail", "Biker-CharacterThumbnail", "BusinessMan-CharacterThumbnail", "Criminal-CharacterThumbnail", "Hazmat-CharacterThumbnail", "Homeless-CharacterThumbnail", "Hunter-CharacterThumbnail", "Islander-CharacterThumbnail", "RiotCop-CharacterThumbnail", "Sheriff-CharacterThumbnail", "Soldier-CharacterThumbnail"]
      , i = {
        "bandana-HatThumbnail": 0,
        "beanie-HatThumbnail": 0,
        "beer-HatThumbnail": 2,
        "bunny-HatThumbnail": 0,
        "cap-HatThumbnail": 0,
        "captain-HatThumbnail": 0,
        "cowboy-HatThumbnail": 0,
        "crown-HatThumbnail": 2,
        "cupcake-HatThumbnail": 0,
        "elf-HatThumbnail": 0,
        "fez-HatThumbnail": 0,
        "party-HatThumbnail": 3,
        "pot-HatThumbnail": 3,
        "racoon-HatThumbnail": 4,
        "roman-HatThumbnail": 0,
        "samurai-HatThumbnail": 3,
        "shark-HatThumbnail": 3,
        "squid-HatThumbnail": 2,
        "tacticle-HatThumbnail": 1,
        "unicorn-HatThumbnail": 3,
        "Biker-CharacterThumbnail": 0,
        "BusinessMan-CharacterThumbnail": 1,
        "Criminal-CharacterThumbnail": 0,
        "Hazmat-CharacterThumbnail": 0,
        "Homeless-CharacterThumbnail": 0,
        "Hunter-CharacterThumbnail": 0,
        "Islander-CharacterThumbnail": 0,
        "RiotCop-CharacterThumbnail": 0,
        "Sheriff-CharacterThumbnail": 1,
        "Soldier-CharacterThumbnail": 3
    };
    e = (e = Utils.shuffle(e)).slice(0, 25);
    for (var n = Math.random(), a = ["COMMON", "UNCOMMON", "RARE", "MYTHICAL", "OP"][i[t]], o = 0; o < 25; o++) {
        var s = e[o];
        22 == o && (s = t);
        var r = i[s]
          , u = this.app.assets.find(s)
          , l = this.rewardItem.clone();
        l.enabled = !0,
        l.findByName("Color").element.color = this.rareColors[r],
        l.findByName("Icon").element.textureAsset = u,
        l.findByName("Title").element.text = s.split("-")[0],
        l.setLocalPosition(190 * o, 0, 0),
        "HatThumbnail" == s.split("-")[1] ? l.findByName("Icon").setLocalPosition(0, 10, 0) : (l.findByName("Icon").element.width = 130,
        l.findByName("Icon").element.height = 130),
        this.rewardItems.addChild(l),
        this.rewardItemsList.push(l)
    }
    this.rewardItems.tween(this.rewardItems.getLocalPosition()).to({
        x: -3250,
        y: 0,
        z: 0
    }, 2, pc.Linear).start(),
    setTimeout(function(t) {
        var e = Math.floor(80 * Math.random());
        t.rewardItems.tween(t.rewardItems.getLocalPosition()).to({
            x: -3950 + e,
            y: 0,
            z: 0
        }, 2, pc.QuadraticOut).start()
    }, 2e3, this),
    setTimeout(function(e) {
        e.rewardTitle.element.text = t.split("-")[0] + " [" + a + "]",
        e.rewardButton.script.button.resolve(),
        e.entity.sound.play("LootBox"),
        e.entity.sound.slots.LootBox.pitch = .1 * n + .9
    }, 4e3, this),
    this.profileModal.script.profile.decreaseGold(750)
}
,
...
,
Menu.prototype.showClanManager = function() {
    this.clanManagerEntity.enabled = !0
}
,
Menu.prototype.hideClanManager = function() {
    this.clanManagerEntity.enabled = !1
}
,
Menu.prototype.showClanCreate = function() {
    this.clanCreateEntity.enabled = !0
}
,
Menu.prototype.hideClanCreate = function() {
    this.clanCreateEntity.enabled = !1
}
,
Menu.prototype.showSocialTasks = function() {
    this.socialTasksEntity.enabled = !0
}
,
Menu.prototype.hideSocialTasks = function() {
    this.socialTasksEntity.enabled = !1
}
,
Menu.prototype.showServerSelection = function() {
    if (this.alreadyWaitingMatch)
        return !1;
    this.serverSelectionEntity.enabled = !0
}
,
Menu.prototype.hideServerSelection = function() {
    this.serverSelectionEntity.enabled = !1
}
,
Menu.prototype.openSocialLink = function(t) {
    var e = -1e3
      , i = this;
    "twitter" == t ? (e = Date.now(),
    window.open("https://twitter.com/onrushstudio"),
    window.onfocus = function() {
        Date.now() - e > 2e3 ? i.getGoldForSocial("twitch") : i.showAlert("Make sure you followed our twitter page!"),
        window.onfocus = !1
    }
    ) : "twitch" == t && (e = Date.now(),
    window.open("https://www.twitch.tv/directory/game/MiniRoyale"),
    window.onfocus = function() {
        Date.now() - e > 2e3 ? i.getGoldForSocial("twitch") : i.showAlert("Make sure you followed our twitch category!"),
        window.onfocus = !1
    }
    )
}
,
Menu.prototype.getGoldForSocial = function(t) {
    var e = this;
    Service.post("claim_social_reward", {
        hash: pc.hash,
        type: t
    }, function(t) {
        e.showAlert(t.message)
    })
}
,
Menu.prototype.getGold = function() {
    var t = this;
    isAdsBlocked ? this.showAlert("Please disable Adblock extension!") : (this.playButton && (this.playButton.button.active = !1,
    this.playButton.script.button.active = !1,
    this.profileModal.script.profile.getGold(function(e) {
        t.showAlert(e),
        t.playButton.button.active = !0,
        t.playButton.script.button.active = !0
    }, function(e) {
        t.showAlert(e),
        t.playButton.button.active = !0,
        t.playButton.script.button.active = !0
...
,
Menu.prototype.switchHat = function(t) {
    return this.app.assets.find(t + "-Hat") ? pc.currentSkin ? (pc.hat = t,
    this.switchSkin(pc.currentSkin),
    void this.profileModal.script.profile.setHat(t)) : (pc.currentSkin = "Biker",
    this.profileModal.script.profile.setHat(t),
    !1) : (this.hatModelEntity.enabled = !1,
    pc.hat = !1,
    Service.set("hat_name", !1),
    !1)
}
,
Menu.prototype.refreshLeaderboard = function() {
    this.app.fire("Leaderboard:Refresh", !0)
}
,
Menu.prototype.buyCrate = function(t, e) {
    this.rewardContentEntity.enabled;
    var i = this;
    setTimeout(function() {
        i.buyCrateButton.script.button.loading()
    }, 100, this),
    this.profileModal.script.profile.buyCrate(t, function(t) {
        e.resolve(),
        setTimeout(function(t) {
            t.buyCrateButton.script.button.resolve()
        }, 4e3, i),
        i.openReward(t)
    }, function(t) {
        e.resolve(),
        i.buyCrateButton.script.button.resolve(),
        i.showAlert(t)
    }),
    this.lastCrateBuy = Date.now()
}
,
Menu.prototype.showCrateUnlock = function() {
    this.rewardContentEntity.enabled = !0
}
,
Menu.prototype.showConfirm = function(t) {
    this.confirmEntity.enabled = !0,
    this.confirmText.element.text = t
}
,
Menu.prototype.closeConfirm = function() {
    this.confirmEntity.enabled = !1
}
,
...
Menu.prototype.showPreroll = function() {
    ...
    var t = this;
    "undefined" == typeof adplayer || "undefined" == typeof aiptag || pc.hash || this.firstLogin ? "undefined" != typeof PokiSDK ? this.app.fire("Ads:Preroll", function() {
        t.findMatch()
    }, function() {
        t.findMatch()
    }) : this.findMatch() : this.app.fire("Ads:Preroll", function() {
        t.findMatch()
    }, function() {
        t.findMatch()
    })
...
,
Menu.prototype.hideAttachments = function() {
    this.weaponEntity.destroy(),
    this.hatEntity.destroy()
}
,
Menu.prototype.requestScene = function(t, e, i) {
    pc.selectedMap = i,
    pc.network.IP = t,
    pc.network.roomId = e,
    pc.network.radiusId = 1,
    pc.network.gameMode = "BATTLEROYALE",
    this.loadingText.enabled = !0,
    this.transitionEntity.enabled = !0,
    this.transitionEntity.tween(this.transitionEntity.getLocalPosition()).to({
        x: 300,
        y: -365,
        z: 0
    }, .8, pc.BackOut).start(),
    this.app.fire("Ads:BannerDestroy", "miniroyale-728x90", "728x90"),
    setTimeout(function(t) {
        t.loadScene("Loader")
    }, 800, this)
}
...
Menu.prototype.requestMatch = function() {
    ...
    var i = {
      ...
      , n = window.localStorage.getItem("ServerSelection");
    n && "auto" != n && (i.force_country = "true",
    i.country = pc.country),
    -1 !== pc.inviteId && (pc.inviteId,
    pc.isHost),
    this.hideBanners(),
    Service.post("find_match", i, function(t) {
        ...
        e.loadingText.enabled = !0,
        e.transitionEntity.enabled = !0,
        e.transitionEntity.tween(e.transitionEntity.getLocalPosition()).to({
            x: 300,
            y: -365,
            z: 0
        }, .8, pc.BackOut).start(),
        setTimeout(function() {
            e.loadScene("Loader")
        }, 800)) : alert("Couldn't find match, try again please") : t.waiting ? setTimeout(function() {
            e.requestMatch()
        }, 2e3) : (alert(t.message),
...
Menu.prototype.loadScene = function(t) {
    var e = this
      , i = this.app.scenes.find(t).url
      , n = this.app.root.findByName("Root");
    "undefined" != typeof VERSION && (i = i + "?v=" + VERSION),
    this.app.scenes.loadSceneHierarchy(i, function(t, i) {
...
Menu.prototype.update = function(t) {
    ...
    this.characterEntity.animation.speed = .7) : (this.cameraEntity.camera.fov = pc.math.lerp(this.cameraEntity.camera.fov, 40, .1),
...
Profile.attributes.add("hatHolder", {
    type: "entity"
}),
Profile.attributes.add("hatItem", {
    type: "entity"
}),
...
Profile.attributes.add("clanManagerButton", {
    type: "entity"
}),
Profile.attributes.add("clanCreateButton", {
    type: "entity"
}),
Profile.attributes.add("clanSocialButton", {
    type: "entity"
}),
Profile.attributes.add("clanTitleEntity", {
    type: "entity"
}),
Profile.attributes.add("clanSocialLinkInput", {
    type: "entity"
}),
Profile.attributes.add("clanPrivateInput", {
    type: "entity"
}),
Profile.attributes.add("clanMembersHolder", {
    type: "entity"
}),
Profile.attributes.add("clanMemberEntity", {
    type: "entity"
}),
Profile.attributes.add("clanHubTitle", {
    type: "entity"
}),
Profile.attributes.add("hubMembersHolder", {
    type: "entity"
}),
Profile.attributes.add("hubMemberEntity", {
    type: "entity"
}),
Profile.attributes.add("clanHubEntity", {
    type: "entity"
}),
Profile.attributes.add("clanNotJoinedEntity", {
    type: "entity"
}),
Profile.prototype.initialize = function() {
    ...
    this.followers = [],
    pc.clanSocialLink = !1,
    this.clanMembersArray = [],
    this.hubMembersArray = [],
...
Profile.prototype.setDetails = function(e) {
    ...
    pc.username = i + e.username,
    pc.level = e.level,
    Service.set("hash", pc.hash)),
    pc.isClanOwner = e.is_clan_owner,
    t.getClanDetails(),
    e.clan ? (pc.joinedClan = !0,
    pc.clanSocialLink = e.clan_social_link) : pc.joinedClan = !1;
    var n = Utils.getURLParams("clan");
    n && !pc.joinedClan && t.showClanInvite(n),
    t.usernameElement.element.text = i + e.username,
    ...
    var a = Math.pow(10 * e.level, 2)
      , r = Math.pow(10 * (e.level - 1), 2)
      , s = e.experience - r
      , o = a - r;
    for (var l in t.experienceBar.element.width = 100 * s / o * 4,
    t.experienceElement.element.text = e.experience + " / " + a,
    100 * s / o > 10 ? (t.experienceElement.enabled = !0,
    t.shortcutExperienceElement.enabled = !0) : (t.experienceElement.enabled = !1,
    t.shortcutExperienceElement.enabled = !1),
    t.goldElements) {
        t.goldElements[l].element.text = e.coins + ""
    }
    ...
    t.shortcutUsername.element.text = i + e.username,
    ...
    t.shortcutExperienceBar.element.width = 100 * s / o * 1.5,
    t.shortcutExperienceElement.element.text = e.experience + "",
    ...
    pc._username = decodeURIComponent(escape(btoa(i + e.username))),
...
,
Profile.prototype.showClanInvite = function(e) {
    var t = atob(e);
    t = t.split(":::"),
    this.menuEntity.script.menu.showConfirm(t[2] + " invites you to clan!");
    var i = this;
    pc.acceptCallback = function() {
        i.acceptClanInvite(),
        i.menuEntity.script.menu.closeConfirm()
    }
    ,
    pc.declineCallback = function() {
        i.menuEntity.script.menu.closeConfirm()
    }
}
,
Profile.prototype.acceptClanInvite = function() {
    var e = Utils.getURLParams("clan");
    e && (e = (e = atob(e)).split(":::"),
    Service.post("accept_invite_link", {
        clan_id: e[0],
        hash: e[1]
    }, function(e) {
        e.success,
...
,
Profile.prototype.decreaseGold = function(e) {
    var t = parseInt(this.goldElements[0].element.text) - e;
    for (var i in this.goldElements) {
        this.goldElements[i].element.text = t + ""
    }
}
,
Profile.prototype.goClanPage = function() {
    pc.clanSocialLink && pc.clanSocialLink.length > 3 && window.open(pc.clanSocialLink)
}
,
Profile.prototype.getClanDetails = function() {
    var e = this;
    Service.post("get_clan_details", {
        hash: pc.hash
    }, function(t) {
        t.success ? (e.clanHubEntity.enabled = !0,
        e.clanNotJoinedEntity.enabled = !1,
        pc.isClanOwner ? (e.clanManagerButton.enabled = !0,
        e.clanCreateButton.enabled = !1,
        e.clanSocialButton.enabled = !1) : (e.clanCreateButton.enabled = !1,
        e.clanSocialButton.enabled = !0),
        e.setHubMembersList(t.members),
        pc.isClanOwner && (Service.get("clan_requests") < t.members.length && pc.app.fire("Interface:Notification", "You clan has new member requests!"),
        Service.set("clan_requests", t.members.length),
        e.setClanMembersList(t.members)),
        t.social_link && e.clanSocialLinkInput.script.input.setValue(t.social_link),
        "1" == t.is_private ? e.clanPrivateInput.script.checkbox.setValue(!0) : e.clanPrivateInput.script.checkbox.setValue(!1),
        e.clanTitleEntity.element.text = "[" + t.slug + "] " + t.clan_name + " - Clan Management",
        e.clanHubTitle.element.text = "[" + t.slug + "] " + t.clan_name + " - Members : " + t.members.length) : (e.clanManagerButton.enabled = !1,
        e.clanCreateButton.enabled = !0)
    })
}
,
Profile.prototype.deleteClan = function() {
    !0 === confirm("Are you sure?") && Service.post("delete_clan", {
        hash: pc.hash
    }, function(e) {
        pc.app.fire("Menu:ShowAlert", e.message),
        setTimeout(function() {
            window.location.reload()
        }, 1e3)
    })
...
,
Profile.prototype.quitFromClan = function() {
    !0 === confirm("Are you sure?") && Service.post("quit_clan", {
        hash: pc.hash
    }, function(e) {
        alert(e.message)
    })
...
,
Profile.prototype.joinClan = function(e) {
    Service.post("join_clan", {
        hash: pc.hash,
        clan_id: e
    }, function(e) {
        pc.app.fire("Menu:ShowAlert", e.message)
...
,
Profile.prototype.joinClanCode = function() {
    var e = prompt("Please enter clan short code, without [], eg. BOOF", "");
    e && Service.post("join_clan_code", {
        hash: pc.hash,
        clan_slug: e
    }, function(e) {
        pc.app.fire("Menu:ShowAlert", e.message)
...
,
Profile.prototype.clearClanMembers = function() {
    for (var e = this.clanMembersArray.length; e--; )
        this.clanMembersArray[e].destroy();
    this.clanMembersArray = []
}
,
Profile.prototype.setClanMembersList = function(e) {
    for (var t in this.clearClanMembers(),
    this.clanMemberEntity.enabled = !1,
    e) {
        var i = e[t]
          , n = this.clanMemberEntity.clone();
        n.enabled = !0,
        n.setLocalPosition(0, 32 * -parseInt(t), 0),
        n.findByName("Username").element.text = i.username,
        n.findByName("Username").findByName("Verified").enabled = "1" == i.verified,
        n.findByName("Level").element.text = i.level,
        n.findByName("LastLogin").element.text = i.last_login,
        i.active_skin ? n.findByName("ProfilePicture").element.textureAsset = this.app.assets.find(i.active_skin + "-CharacterThumbnail") : n.findByName("ProfilePicture").element.textureAsset = this.app.assets.find("no_photo.jpg"),
        "1" == i.approved && (n.findByName("ApproveButton").enabled = !1),
        n.findByName("ApproveButton").script.button.triggerFunction = 'profile.approveClanMember("' + i.user_id + '");',
        n.findByName("KickButton").script.button.triggerFunction = 'profile.kickClanMember("' + i.user_id + '");',
        "0" == i.apprved && (n.findByName("KickDeny").element.text = "Deny"),
        this.clanMembersHolder.addChild(n),
        this.clanMembersArray.push(n)
    }
}
,
Profile.prototype.clearHubMembers = function() {
    for (var e = this.hubMembersArray.length; e--; )
        this.hubMembersArray[e].destroy();
    this.hubMembersArray = []
}
,
Profile.prototype.setHubMembersList = function(e) {
    for (var t in this.clearHubMembers(),
    this.hubMemberEntity.enabled = !1,
    e) {
        var i = e[t];
        if ("1" == i.approved) {
            var n = this.hubMemberEntity.clone();
            n.enabled = !0,
            n.setLocalPosition(0, 32 * -parseInt(t), 0),
            n.findByName("Username").element.text = i.username,
            n.findByName("Username").findByName("Verified").enabled = "1" == i.verified,
            n.findByName("Level").element.text = i.level,
            n.findByName("LastLogin").element.text = i.last_login,
            n.findByName("TodayExperience").element.text = "Today XP : " + i.today_experience,
            i.active_skin ? n.findByName("ProfilePicture").element.textureAsset = this.app.assets.find(i.active_skin + "-CharacterThumbnail") : n.findByName("ProfilePicture").element.textureAsset = this.app.assets.find("no_photo.jpg"),
            this.hubMembersHolder.addChild(n),
            this.hubMembersArray.push(n)
        }
    }
}
,
Profile.prototype.approveClanMember = function(e) {
    var t = this;
    !0 === confirm("Are you sure?") && Service.post("approve_clan_member", {
        hash: pc.hash,
        user_id: e
    }, function(e) {
        e.success ? (alert(e.message),
        t.getClanDetails()) : alert(e.message)
    })
}
,
Profile.prototype.kickClanMember = function(e) {
    var t = this;
    !0 === confirm("Are you sure?") && Service.post("kick_clan_member", {
        hash: pc.hash,
        user_id: e
    }, function(e) {
        e.success ? (alert(e.message),
...
Profile.prototype.setBadges = function(e) {
    ...
    for (var i in t) {
        var n = t[i];
        if (n) {
            var a = this.app.assets.find(n + "-badge.png");
            if (a) {
                var r = this.badgeElement.clone();
                r.element.textureAsset = a.id,
                r.enabled = !0,
                r.setLocalPosition(40 * -parseInt(i), 0, 0),
                this.badgesHolder.addChild(r)
            }
        }
    }
}
...
Profile.prototype.setFriends = function(e) {
    ...
    null != Service.get("followers") && Service.get("followers") < t.length) {
        ...
        n > 0 && this.app.fire("Interface:Notification", 'You have [color="#FFFF00"]' + n + " new[/color] followers.")
    }
    for (var a in Service.set("followers", t.length),
    i) {
        var r = i[a];
        this.friendRowEntity.findByName("Username").element.text = r.username,
        this.friendRowEntity.findByName("Unfollow").script.button.triggerFunction = "profile.unfollowFriend('" + r.username + "');",
        r.active_skin ? this.friendRowEntity.findByName("ProfileImage").element.textureAsset = this.app.assets.find(r.active_skin + "-CharacterThumbnail") : this.friendRowEntity.findByName("ProfileImage").element.textureAsset = this.app.assets.find("no_photo.jpg");
        var s = this.friendRowEntity.clone();
        s.setLocalPosition(0, -parseInt(33 * a), 0),
        s.enabled = !0,
        this.friendsContent.addChild(s),
        this.followedUsers.push(s)
    }
    for (var o in t) {
        var l = t[o];
...
Profile.prototype.setDefaultSkin = function() {
    var e = Service.get("skin_name")
      , t = Service.get("hat_name");
    t ? (pc.currentSkin = e,
    this.menuEntity.script.menu.switchHat(t)) : this.menuEntity.script.menu.switchSkin(e)
}
,
Profile.prototype.setSkin = function(e) {
    ...
    Service.get("skin_name") != e && Service.post("set_skin", {
        skin_name: e,
        hash: pc.hash
    }, function(t) {
...
,
Profile.prototype.getHats = function() {
    var e = this;
    Service.post("get_hats", {
        hash: pc.hash
    }, function(t) {
        t.success && e.setHats(t)
    }, Service.authURL)
}
,
Profile.prototype.clearHats = function() {
    for (var e = this.hats.length; e--; )
        this.hats[e] && this.hats[e].destroy();
    this.hats = []
}
,
Profile.prototype.setHats = function(e) {
    this.clearHats();
    var t = []
      , i = 0
      , n = e.hats;
    for (var a in n) {
        var r = n[a]
          , s = r.name
          , o = r.quantity
          , l = this.app.assets.find(s + "-HatThumbnail");
        this.app.assets.find(s + "-Hat");
        if (-1 === t.indexOf(s)) {
            var d = parseInt(i) % 4
              , c = Math.floor(parseInt(i) / 4)
              , f = this.hatItem.clone();
            f.name = s,
            f.enabled = !0,
            f.activeIcon = f.findByName("Active"),
            f.activeIcon.enabled = !1,
            f.findByName("Name").element.text = s,
            f.findByName("Quantity").element.text = o + "x",
            f.findByName("Thumbnail").element.textureAsset = l,
            f.findByName("SwitchButton").script.button.triggerFunction = "menu.switchHat('" + s + "');",
            f.setLocalPosition(140 * d, -140 * c, 0),
            this.hatHolder.addChild(f),
            this.hats.push(f),
            t.push(s),
            i++
        }
    }
    var h = Service.get("hat_name");
    h && this.setHat(h)
}
,
Profile.prototype.setHat = function(e) {
    if (this.currentHat == e)
        return !1;
    if (void 0 === this.hats)
        return !1;
    for (var t = this.hats.length; t--; ) {
        var i = this.hats[t];
        i.name == e ? i.activeIcon.enabled = !0 : i.activeIcon.enabled = !1
    }
    Service.post("set_hat", {
        hat_name: e,
        hash: pc.hash
    }, function(t) {
        t.success && Service.set("hat_name", e)
    }, Service.authURL),
    this.currentHat = e,
    pc.currentHat = this.currentHat
}
,
...
Profile.prototype.setSkins = function(e) {
    ...
    for (var a in n) {
        var r = n[a]
          , s = r.name
          , o = r.quantity
          , l = this.app.assets.find(s + "-CharacterThumbnail");
        if (this.app.assets.find(s + "-Character") && -1 === t.indexOf(s)) {
            var d = parseInt(i) % 4
              , c = Math.floor(parseInt(i) / 4)
              , f = this.skinItem.clone();
            f.name = s,
            f.enabled = !0,
            f.activeIcon = f.findByName("Active"),
            f.activeIcon.enabled = !1,
            ...
            f.findByName("Quantity").element.text = o + "x",
            f.findByName("Thumbnail").element.textureAsset = l,
            f.findByName("SwitchButton").script.button.triggerFunction = "menu.switchSkin('" + s + "');",
            f.setLocalPosition(140 * d, -140 * c, 0),
            this.skinHolder.addChild(f),
            this.skins.push(f),
            t.push(s),
            i++
        }
    }
    var h = Service.get("skin_name");
    h && this.setSkin(h)
}
,
Profile.prototype.clearFriendLeaderboard = function() {
    for (var e in this.friendLeaderboard) {
        ...
        this.friendLeaderboard[e] && this.friendLeaderboard[e].destroy()
    }
    this.friendLeaderboard = []
}
,
Profile.prototype.getFriendLeaderboard = function(e) {
    ...
    Service.post("get_friend_leaderboard", {
        hash: pc.hash
    }, function(e) {
...
Profile.prototype.setFriendLeaderboard = function(e) {
    ...
    for (var n in e) {
        var a = e[n]
          , r = this.app.assets.find("Biker-CharacterThumbnail");
        a.active_skin && (r = this.app.assets.find(a.active_skin + "-CharacterThumbnail"));
        var s = this.friendLeaderboardRow.clone();
        s.enabled = !0,
        s.findByName("Background").element.opacity = t % 2 == 0 ? .1 : .05;
        var o = s.findByName("Username")
          , l = a.clan ? "[" + a.clan + "] " : ""
          , d = a.username.length > 15 ? a.username.slice(0, 15) + "..." : a.username;
        o.element.text = l + d,
        o.findByName("Verified").enabled = "1" == a.verified,
        "1" == a.verified && o.setLocalPosition(o.getLocalPosition().add(new pc.Vec3(25,0,0))),
        s.findByName("Level").element.text = parseInt(a.level) + "",
        s.findByName("ProfilePicture").element.textureAsset = r,
        s.findByName("Invite").script.button.triggerFunction = "menu.inviteUser('" + a.username + "');",
        s.findByName("WaitingInvite").enabled = !1,
        "none" != this.partyId ? (s.findByName("Invite").enabled = !1,
        s.findByName("InParty").enabled = !1,
        s.findByName("LastSeen").enabled = !1,
        s.findByName("OnlineDisplay").enabled = !1) : !1 !== this.invitedUsername ? (s.findByName("Invite").enabled = !1,
        s.findByName("InParty").enabled = !1,
        s.findByName("LastSeen").enabled = !1,
        this.invitedUsername == a.username && "none" == this.partyId && (s.findByName("WaitingInvite").enabled = !0)) : this.onlineFriends.indexOf(a.username) > -1 ? (s.findByName("OnlineDisplay").enabled = !0,
        s.findByName("Invite").enabled = !0,
        a.in_party ? (s.findByName("Invite").enabled = !1,
        s.findByName("InParty").enabled = !0) : s.findByName("InParty").enabled = !1,
        s.findByName("LastSeen").enabled = !1) : (s.findByName("OnlineDisplay").enabled = !1,
        s.findByName("Invite").enabled = !1,
        s.findByName("InParty").enabled = !1,
        s.findByName("LastSeen").enabled = !0,
        s.findByName("LastSeen").element.text = a.last_seen),
        s.setLocalPosition(0, 30 * -t, 0),
        this.friendLeaderboard.push(s),
        this.friendLeaderboardHolder.addChild(s),
        i.push(a.username),
        t++
    }
...
Profile.prototype.logout = function() {
    ...
    Service.post("logout", {}, function(t) {
        ...
        window.localStorage.removeItem("miniroyale2_account_details"),
        window.localStorage.removeItem("miniroyale2_friends"),
...
Parachute.attributes.add("characterHat", {
    type: "entity"
}),
Parachute.attributes.add("characterHatHolder", {
    type: "entity"
}),
...
Parachute.prototype.changeDirection = function() {
    var t = this.entity.getPosition().clone()
      ...
      , a = Utils.lookAt(t.x, t.z, Utils.zeroVector.x, Utils.zeroVector.z);
    a *= pc.math.RAD_TO_DEG,
    e > this.mapDistance ? a > -35 && a < 35 || (a > 0 ? this.currentAngle -= this.turnSpeed : this.currentAngle += this.turnSpeed,
...
Parachute.prototype.setSkin = function(t) {
    var e = this.app.assets.find(t + "-Character")
      , a = this;
    t && e && (this.characterEntity.model.asset = e,
    e.ready(function() {
        a.attachHat()
    }))
}
,
Parachute.prototype.attachHat = function() {
    var t = this.characterEntity.findByName("Head");
    if (this.characterHatHolder.reparent(t),
    this.characterHatHolder.setLocalScale(100, 100, 100),
    pc.hat) {
        var e = this.app.assets.find(pc.hat + "-Hat");
        e && (this.characterHat.model.asset = e)
    }
}
,
...
Parachute.prototype.setCurrentHeight = function() {
    var t = this.entity.getPosition().clone()
      ...
      , a = this.app.systems.rigidbody.raycastFirst(t, e)
      , i = 1e3;
    a && a.entity && "Enemy" != a.entity.name && (i = a.point.sub(this.entity.getPosition().clone()).length()),
    this.height = i,
...
Parachute.prototype.setCurrentValues = function() {
    ...
    this.currentWindVolume = pc.math.lerp(this.currentWindVolume, a, .08),
    this.entity.sound.slots.HeavyWind && (this.entity.sound.slots.HeavyWind.volume = this.currentWindVolume);
    var i = this.entity.getPosition().clone();
    this.compassElement.script.compass.currentPosition.x = i.x,
    this.compassElement.script.compass.currentPosition.z = i.z,
...
Parachute.prototype.setCameraPoint = function(t) {
    var e = this.fallPoint
      , a = 5 * Math.cos(this.timestamp / 3)
      , i = 1 * Math.sin(this.timestamp / 3)
      , r = .05;
    this.height < this.parachuteOpenLimit && (e = this.parachutePoint,
    a = 1 * Math.cos(this.timestamp / 20),
    i = 1 * Math.sin(this.timestamp / 20)),
    this.onGround && (e = this.facePoint,
    r = .1);
    var s = e.getLocalPosition().clone()
      , n = e.getLocalEulerAngles().clone();
    n.add(new pc.Vec3(a,i,0));
    var h = this.cameraEntity.getLocalPosition()
      , o = this.cameraEntity.getLocalEulerAngles()
      , c = h.lerp(h.clone(), s.clone(), r)
      , p = o.lerp(o.clone(), n.clone(), r);
...
,
Inventory.prototype.removeItemFromInventory = function(t, e) {
...
Attr.attributes.add("icon", {
    type: "asset",
    assetType: "texture"
}),
Attr.attributes.add("color", {
    type: "rgb"
}),
...
Network.prototype.initialize = function() {
    ...
    this.app.on("Flag:Captured", this.setCaptureFlag, this),
    this.app.on("Flag:Saved", this.setSavedFlag, this),
    this.app.on("Flag:Back", this.setFlagBack, this),
    ...
    void 0 !== pc.currentSkin ? this.skin = pc.currentSkin : this.skin = "",
    void 0 !== pc.level ? this.level = pc.level : this.level = 0,
...
Network.prototype.reconnect = function() {
    ...
    var s = {
      ...
      , i = window.localStorage.getItem("ServerSelection");
    i && "auto" != i && (s.force_country = "true",
    s.country = pc.country),
    Service.post("find_match", s, function(t) {
...
Network.prototype.kicked = function(t) {
    t.length > 0 && (alert("You have been kicked!"),
    window.location.href = "https://miniroyale2.io/?kicked=hack")
}
,
...
,
Network.prototype.setThrow = function(t, e, s, i, o, a, r, n) {
    this.broadcast([this.ws.map.throw, t, e, s, i, o, a, r, n])
}
,
Network.prototype.teams = function(t) {
    if (t.length > 0)
        for (var e in t[0]) {
            var s = t[0][e];
            this.app.fire("Team:Selection", s.playerId, s.team, s.username, s.skin, s.level)
        }
}
,
Network.prototype.ready = function(t) {
    this.app.fire("Player:Ready", !0)
}
,
...
,
Network.prototype.setCaptureFlag = function(t, e) {
    this.broadcast([this.ws.map.capture, !0])
}
,
Network.prototype.setSavedFlag = function() {
    this.broadcast([this.ws.map.save_flag, !0])
}
,
Network.prototype.setFlagBack = function() {
    this.broadcast([this.ws.map.back_flag, !0])
}
,
Network.prototype.back_flag = function(t) {
    pc.currentTeam == t[1] ? this.app.fire("Notification:Team", "Your team flag saved!", t[1]) : this.app.fire("Notification:Team", "[team]" + t[1] + "[/team] team saved their flag!", t[1]),
    this.app.fire("Flag:BackCompleted", t[0], t[1])
}
,
Network.prototype.capture = function(t) {
    this.ws.userId == t[0] ? this.app.fire("Player:Capture", t[0], t[1]) : (this.app.fire("Enemy:Capture", t[0], t[1]),
    pc.currentTeam != t[1] && this.app.fire("Notification:Team", "[team]" + t[1] + "[/team] team picked the flag!", t[1])),
    this.ws.userId != t[0] && pc.currentTeam == t[1] && (this.app.fire("Team:Capture", t[0], t[1]),
    this.app.fire("Notification:Team", "Your teammate picked the flag!", t[1])),
    this.app.fire("Event:Chat", "Console", "Flag taken by " + t[1] + " team.", !0)
}
,
Network.prototype.save_flag = function(t) {
    this.ws.userId == t[0] ? this.app.fire("Player:SaveFlag", t[0], t[1]) : (this.app.fire("Enemy:SaveFlag", t[0], t[1]),
    pc.currentTeam != t[1] ? this.app.fire("Notification:Team", "[team]" + t[1] + "[/team] captured the flag!", t[1]) : this.app.fire("Notification:Team", "Your teammate captured the flag!", t[1])),
    this.app.fire("Score:SaveFlag", t[0], t[1], t[2]),
    this.app.fire("Event:Chat", "Console", "Flag captured by " + t[1] + " team.", !0)
}
,
...
,
Network.prototype.deployStart = function(data) {
    try {
        this.broadcast([this.ws.map.deployStart, eval(data[0])])
    } catch (t) {}
}
,
...
Network.prototype.result = function(t) {
    ...
    this.controls && "battle-royale" == pc.currentMode && 1 == e && setTimeout(function(t) {
        t.app.fire("Event:Victory", !0)
    }, 1e3, this),
    this.controls && this.controls.showResults(s),
...
,
Network.prototype.finish = function(t) {
    var e = []
      , s = []
      , i = {}
      , o = 0
    ...
    for (var r in t[0]) {
        var n = t[0][r];
        if (pc.userId == n.playerId) {
            n.isHover = !0;
            var p = n.experience;
            i = {
                experience: p,
                killPoint: 10 * n.kills + 20 * n.headshots,
                timePoint: 9,
                coins: .09 * p
            }
        }
        "blue" == n.team ? (e.push(n),
        a += n.experience) : "red" == n.team && (s.push(n),
        o += n.experience)
    }
    e = Object.values(e),
    s = Object.values(s),
    ...
    pc.victoryTeam = o > a ? "red" : "blue",
    this.app.fire("Game:Finished", !0),
    this.controls.showResults(i, 1),
    setTimeout(function(t) {
        t.app.fire("Table:Set", "blue_team", e),
        t.app.fire("Table:Set", "red_team", s)
    }, 500, this)
}
,
Network.prototype.score = function(t) {
    this.app.fire("Player:Score", t[0], t[1])
}
,
...
Network.prototype.auth = function(t) {
    this.ws.roomId = t[0],
    this.ws.userId = t[1],
    btoa(unescape(encodeURIComponent(pc.username))) != pc._username && (this.username = "Guest"),
    pc.userId = this.ws.userId,
    this.broadcast([this.ws.map.join, this.ws.userId, this.hash, this.username, this.skin, this.hat, this.level]),
...
Network.prototype.join = function(t) {
    ...
    this.app.fire("Enemy:Create", e.id, e.username, e.weapon, e.location, e.skin, e.hat, e.team, e.level)
}
,
Network.prototype.users = function(t) {
    for (var e = t[0], s = e.length; s--; )
        this.app.fire("Enemy:Create", e[s].id, e[s].username, e[s].weapon, e[s].location, e[s].skin, e[s].hat, e[s].team, e[s].level)
}
,
...
Network.prototype.team = function(t) {
    if (t.length < 1)
        return !1;
    this.ws.userId == t[0] && (pc.currentTeam = t[1]),
...
,
Network.prototype.protection = function(t) {
    if (t.length > 0) {
        var e = t[0]
          , s = this.getPlayerById(e);
        s.script && s.script.enemy && this.ws.userId != e && s.script.enemy.hideProtection(),
        this.ws.userId == e && this.app.fire("Player:DisableProtection", !0)
    }
}
,
...
PlayerManager.prototype.initialize = function() {
    ...
    this.app.on("Team:Selection", this.setTeam.bind(this), this),
    this.app.on("Enemy:Capture", this.setPlayerCapture, this),
    this.app.on("Enemy:SaveFlag", this.setPlayerFlagSave, this),
    this.app.on("Grenade:Throw", this.setThrow.bind(this), this)
}
,
PlayerManager.prototype.setTeam = function(e, t) {
    var a = this.findByPlayerId(e);
    if (a)
        for (var r in a.script.enemy.team = t,
        this.playersData) {
            this.playersData[r].playerId == e && (this.playersData[r].team = t)
        }
    else
        this.preSelectedTeam.push({
            playerId: e,
            team: t
        })
}
,
PlayerManager.prototype.updateTeamSelections = function() {
    if (Date.now() - this.lastTeamUpdate < 1e3)
        return !1;
    for (var e = this.players.length; e--; ) {
        this.players[e];
        for (var t in this.preSelectedTeam) {
            var a = this.preSelectedTeam[t];
            parseInt(a.playerId) == parseInt(this.players[e].playerId) && this.players[e] && this.players[e].script && this.players[e].script.enemy && (this.players[e].script.enemy.team = a.team)
        }
    }
    this.lastTeamUpdate = Date.now()
}
,
PlayerManager.prototype.update = function(e) {
    this.updateTeamSelections()
}
,
PlayerManager.prototype.setPlayerCapture = function(e, t) {
    var a = this.findByPlayerId(e);
    a && a.script.enemy.setFlag()
}
,
PlayerManager.prototype.setPlayerFlagSave = function(e, t) {
    var a = this.findByPlayerId(e);
    a && (a.team,
    pc.currentTeam,
    a.script.enemy.disableFlag())
}
,
PlayerManager.prototype.getFlagCarriers = function(e) {
    for (var t = this.players.length, a = !1; t--; )
        this.players[t] && this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.isCarryFlag && this.players[t].script.enemy.team != e && (a = !0);
    return a
}
,
PlayerManager.prototype.getTeamFlagCarriers = function(e) {
    for (var t = this.players.length, a = !1; t--; )
        this.players[t] && this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.isCarryFlag && this.players[t].script.enemy.team == e && (a = !0);
    return a
}
,
PlayerManager.prototype.onPlayerCreate = function(e, t, a, r, s, i, n, p) {
    if (this.findByPlayerId(e))
        return !1;
    var y = this.enemyEntity.clone();
    a && (y.script.enemy.currentWeapon = a),
    y.enabled = !0,
    y.playerId = e,
    y.script.enemy.playerId = e,
    y.script.enemy.team = n,
    t && (y.script.enemy.username = t),
    s && (y.script.enemy.skin = s,
    y.script.enemy.setSkin(y.script.enemy.skin)),
    i && (y.script.enemy.hat = i,
    y.script.enemy.setHat(y.script.enemy.hat)),
    y.sound.positional = !0,
    y.script.enemy.networkEntity = this.networkEntity,
    this.entity.addChild(y),
    this.players.push(y),
...
PlayerManager.prototype.findByPlayerId = function(e) {
    for (var t = !1, a = this.players.length; a--; )
        this.players[a] && parseInt(this.players[a].playerId) == parseInt(e) && (t = this.players[a]);
    return t
}
,
PlayerManager.prototype.onPlayerPosition = function(e) {
    for (var t = this.players.length; t--; ) {
        ...
        a.playerId == e[0] && a && a.script && a.script.enemy && a.script.enemy.setPosition(e)
    }
}
,
PlayerManager.prototype.onPlayerDestroy = function(e) {
    for (var t = this.players.length; t--; ) {
        var a = this.players[t];
        a.playerId == e[0] && (a && a.script && a.script.enemy ? a.script.enemy.removeEnemy() : a.destroy(),
        this.players.splice(t, 1))
    }
}
,
PlayerManager.prototype.onKeyboardState = function(e, t, a) {
    for (var r = this.players.length; r--; ) {
        var s = this.players[r];
        s && s.playerId == e && s.script && s.script.enemy && s.script.enemy.setInput(t, a)
    }
}
,
PlayerManager.prototype.setWeapon = function(e, t) {
    for (var a = this.players.length; a--; ) {
        ...
        r && r.playerId == e && r.script && r.script.enemy && r.script.enemy.setWeapon(t)
    }
}
,
PlayerManager.prototype.setLand = function(e) {
    for (var t = this.players.length; t--; ) {
        var a = this.players[t];
        a.playerId == e && a.script.enemy.setLand()
    }
}
,
...
Slider.prototype.updateStyle = function() {
    if (this.entity && this.entity.element && this.entity.element.screenCorners) {
...
Container.prototype.initialize = function() {
    ...
    this.on("state", function(t) {
        ...
        this.element.style.display = "block") : this.element.remove()
    }, this),
...
Container.prototype._onDestroy = function() {
    ...
    try {
        this.fullyRemove && this.element && this.element.remove()
    } catch (t) {}
}
,
...
Container.prototype.update = function(t) {
    Date.now() - this.lastUpdate > 1e3 && (this.updateStyle(),
    this.lastUpdate = Date.now())
}
;
...
PhysicsManager.prototype.checkRigidbodiesV2 = function() {
    if (Date.now() - this.lastRigidUpdate < 150)
        return !1;
    var i = this.rigidbodies.length
      , t = this.currentPosition
      , o = this.lookEntity.getPosition()
      , e = 0;
    for (this.lookADSEntity.enabled && (o = this.lookADSEntity.getPosition()); i--; ) {
        var s = this.rigidbodies[i];
        if (s && s.rigidbody && s.enabled) {
            var d = s.getPosition()
              , n = t.clone().sub(d).length()
              , a = o.clone().sub(d).length()
              , r = 5;
            s && s.model && s.model.meshInstances && s.model.meshInstances.length > 0 && (r = s.model.meshInstances[0].aabb._radius),
            (n < (r += this.threshold) || a < r) && this.maxBodies > e ? (s.rigidbody.enabled = !0,
            s.collision.enabled = !0,
            e++) : n < r && (s.tags.list().indexOf("Batch") > -1 || "Stairway" == s.name || "Body" == s.name || "DefaultRigidbody" == s.name) ? (s.rigidbody.enabled = !0,
            s.collision.enabled = !0) : (s.rigidbody.enabled = !1,
            s.collision.enabled = !1)
        }
    }
    this.lastRigidUpdate = Date.now()
}
...
PhysicsManager.prototype.checkRigidbodies = function() {
    ...
    this.radius = 5); i--; ) {
        var e = this.rigidbodies[i].getPosition().clone()
          , s = Utils.distance(e.x, e.z, t.x, t.z)
          , d = Utils.distance(e.x, e.z, this.lookPosition.x, this.lookPosition.z);
        this.rigidbodies[i].rigidbody && (d < 5 ? (this.rigidbodies[i].rigidbody.enabled = !0,
        this.rigidbodies[i].collision.enabled = !0) : (this.rigidbodies[i].tags.list().indexOf("Batch") > -1 && (s -= 10),
        o.push({
    ...
    disabledBodies = o.slice(this.maxBodies, o.length);
    for (var n = (o = o.slice(0, this.maxBodies)).length; n--; ) {
        var a = o[n];
        a && a.distance < 20 && (a.body.rigidbody.enabled = !0,
        a.body.collision.enabled = !0)
    }
    for (var r = disabledBodies.length; r--; ) {
        var l = disabledBodies[r];
        l && (l.body.rigidbody.enabled = !1,
        l.body.collision.enabled = !1)
    }
    this.lastRigidUpdate = Date.now(),
...
;
var Service = {
    baseURL: "https://gateway.miniroyale2.io",
    authURL: "https://gateway.miniroyale2.io",
...
Scrollbar.attributes.add("speed", {
    type: "number",
    default: .035
}),
Scrollbar.attributes.add("padding", {
    type: "number",
    default: 30
}),
...
,
Scrollbar.prototype.onWheel = function(t) {
    t.event.deltaY > 0 ? this.entity.scrollview.scroll.y = -this.speed : this.entity.scrollview.scroll.y = 1 + this.speed
}
,
Scrollbar.prototype.update = function(t) {
    if (Date.now() - this.lastUpdate > 1e3 && this.contentEntity) {
        var e = 0
          , i = this.contentEntity.children;
        for (var n in i) {
            e += i[n].element.calculatedHeight
        }
        this.contentEntity.element.height = e + this.padding + 20,
        this.lastUpdate = Date.now()
    }
}
;
...
Outline.prototype.setShader = function(e) {
    if (e && e.model && e.model.model && e.model.model.meshInstances) {
        ...
        for (var a = 0; a < t.length; a++) {
            var d = t[a]
              , s = d.material.clone();
            s.chunks.transformVS = this.transformShader,
            s.customFragmentShader = this.edgeToonShader,
            s.cull = pc.CULLFACE_FRONT,
            s.update();
            var n = new pc.MeshInstance(d.node,d.mesh,s);
            n.castShadow = !1,
            n.receiveShadow = !1,
            n.skinInstance = d.skinInstance,
            n.setParameter("edgeSize", this.edgeSize),
            n.setParameter("edgeColor", this.color),
            n.drawOrder = 0,
            n.updateKey(),
            o.push(n)
        }
...
Environment.prototype.initialize = function() {
    if (this.lastShadowUpdate = Date.now(),
    ...
    pc.centerPosition = this.selectedRadiusEntity.getPosition().clone(),
    this.sunLight = this.app.root.findByName("Sun"),
    this.sunLight) {
        var t = this.sunLight.light.intensity;
...
Environment.prototype.update = function(t) {
    ...
    this.lastBirdSound = Date.now()),
    Date.now() - this.lastShadowUpdate > 2500 && this.sunLight && this.sunLight && (this.sunLight.light.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME,
    this.lastShadowUpdate = Date.now(),
    this.nextFrameAffect = !0),
    this.nextFrameAffect && this.sunLight && (this.sunLight.light.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME,
    this.sunLight.light.updateShadow(),
    ...
    if (this.selectedRadiusEntity && "battle-royale" == pc.currentMode) {
        ...
        if (this.bombFelt) {
            var o = this.smokeCircle.getLocalPosition().clone()
              , h = this.selectedRadiusEntity.getPosition().clone();
            this.currentCirclePosition = this.currentCirclePosition.lerp(o, h, .01),
...
Leaderboard.prototype.initialize = function() {
    this.rows = [],
    this.app.on("Leaderboard:Refresh", this.onRefresh, this),
    this.rowEntity.enabled = !1,
    this.onRefresh()
}
,
Leaderboard.prototype.onRefresh = function(e) {
    var t = this;
    this.clearLeaderboard(),
    Service.post("leaderboard", {
        sort: this.sort
    }, function(e) {
        e.success ? "clans" == t.sort ? t.updateClanRows(e.entries) : t.updatePlayerRows(e.entries) : alert("An error occured!")
    })
}
,
Leaderboard.prototype.clearLeaderboard = function(e) {
    for (var t = this.rows.length; t--; )
        this.rows[t].destroy();
    this.rows = []
}
,
Leaderboard.prototype.updatePlayerRows = function(e) {
    for (var t in this.clearLeaderboard(),
    e) {
        var i = e[t]
          , n = this.rowEntity.findByName("Username")
          , r = i.username.length > 20 ? i.username.slice(0, 20) + "..." : i.username;
        n.element.text = r,
        n.findByName("Verified").enabled = "1" == i.verified,
        "1" == i.verified ? n.setLocalPosition(new pc.Vec3(110,0,0)) : n.setLocalPosition(new pc.Vec3(75,0,0)),
        this.rowEntity.findByName("Rank").element.text = parseInt(t) + 1 + ".",
        i.active_skin ? this.rowEntity.findByName("ProfilePicture").element.textureAsset = this.app.assets.find(i.active_skin + "-CharacterThumbnail") : this.rowEntity.findByName("ProfilePicture").element.textureAsset = this.app.assets.find("Biker-CharacterThumbnail"),
        this.rowEntity.findByName("Experience") && (this.rowEntity.findByName("Experience").element.text = i.experience),
        this.rowEntity.findByName("KDR") && i.kdr && (this.rowEntity.findByName("KDR").element.text = i.kdr),
        this.rowEntity.findByName("Kills").element.text = i.kills,
        this.rowEntity.findByName("Deaths").element.text = i.deaths;
        var a = this.rowEntity.clone();
        a.enabled = !0,
        a.setLocalPosition(0, -33 * t, 0),
        this.contentEntity.addChild(a),
        this.rows.push(a)
    }
}
,
Leaderboard.prototype.updateClanRows = function(e) {
    for (var t in this.clearLeaderboard(),
    e) {
        var i = e[t]
          , n = this.rowEntity.findByName("ClanName")
          , r = i.clan_name.length > 20 ? i.clan_name.slice(0, 20) + "..." : i.clan_name;
        n.element.text = r,
        n.findByName("Verified").enabled = "1" == i.verified,
        this.rowEntity.findByName("Rank").element.text = parseInt(t) + 1 + ".",
        this.rowEntity.findByName("Slug").element.text = i.slug,
        this.rowEntity.findByName("OwnerName").element.text = i.owner_username,
        this.rowEntity.findByName("MembersCount").element.text = "Members : " + i.members_count,
        i.previous_rank <= i.rank ? (this.rowEntity.findByName("CaretUp").enabled = !0,
        this.rowEntity.findByName("CaretDown").enabled = !1) : (this.rowEntity.findByName("CaretUp").enabled = !1,
        this.rowEntity.findByName("CaretDown").enabled = !0),
        this.rowEntity.findByName("Experience") && (this.rowEntity.findByName("Experience").element.text = i.experience),
        !pc.joinedClan && "1" != i.is_private && pc.hash ? (this.rowEntity.findByName("JoinCommunity").enabled = !0,
        this.rowEntity.findByName("JoinCommunity").script.button.triggerFunction = 'profile.joinClan("' + i.clan_id + '")') : this.rowEntity.findByName("JoinCommunity").enabled = !1;
        var a = this.rowEntity.clone();
        a.enabled = !0,
        a.setLocalPosition(0, -56 * t, 0),
        this.contentEntity.addChild(a),
        this.rows.push(a)
    }
}
...
Ping.attributes.add("inGame", {
    type: "boolean"
}),
Ping.prototype.initialize = function() {
    this.app.on("Server:Update", this.onUpdate, this),
    this.app.on("Server:DisplayUpdate", this.onUpdate, this),
    this.inGame && this.onUpdate()
}
,
...
Helicopter.attributes.add("waitingConnectionEntity", {
    type: "entity"
}),
...
Helicopter.attributes.add("bannerEntity", {
    type: "entity"
}),
...
Helicopter.prototype.initialize = function() {
    ...
    void 0 !== pc.username ? this.addPlayer(-1, pc.username) : this.addPlayer(-1, "Guest"),
    this.itemManager = this.itemManagerEntity.script.itemSpawn,
    setTimeout(function(t) {
        t.app.fire("Ads:BannerSet", "miniroyale2-io_728x90_2", "728x90")
    }, 100, this)
}
,
...
,
Helicopter.prototype.selectPerk = function(t, e, i) {
    pc.perkItem = this.itemManager.getWeaponDetails(t),
    pc.perkItemAmount = i;
    for (var n = this.perkButtons.length; n--; )
        this.perkButtons[n] && this.perkButtons[n].destroy();
...
Helicopter.prototype.showReconnecting = function() {
    ...
    this.waitingConnectionEntity.enabled = !0,
    setTimeout(function(t) {
        t.reconnectingElement.enabled = !1,
        t.waitingConnectionEntity.enabled = !1
    }, 2e3, this)
}
,
...
Helicopter.prototype.setTick = function(t) {
    ...
    this.bannerEntity.destroy(),
    this.app.fire("Ads:BannerDestroy", "miniroyale-728x90-helicopter", "728x90"),
    ...
    this.waitingConnectionEntity && !0 === this.waitingConnectionEntity.enabled && (this.waitingConnectionEntity.enabled = !1)
}
,
...
Helicopter.prototype.detectPositionFromEvent = function(t) {
    var e = this.app.graphicsDevice.maxPixelRatio
      , i = t.x * e
      , n = t.y * e
      , o = this.pinHolder.element.width
      , s = this.pinHolder.element.height
      , a = o / (this.pinHolder.element.screenCorners[2].x - this.pinHolder.element.screenCorners[0].x)
      , r = s / (this.pinHolder.element.screenCorners[2].y - this.pinHolder.element.screenCorners[0].y)
      , l = this.pinHolder.element.screenCorners[0].x
      , p = this.pinHolder.element.screenCorners[0].y;
    this.pinHolder.getLocalPosition().clone();
    this.posX = 30 * Math.round((i - l) * a / 30),
    this.posZ = 30 * Math.round((n - p) * r / 30),
    this.posX = Math.min(this.posX, 350),
    this.posZ = Math.min(this.posZ, 350)
}
,
...
,
Helicopter.prototype.addPlayer = function(t, e) {
    if (this.playerCount >= 10)
        return !1;
    if (this.playerIdList.indexOf(t) > -1)
        return !1;
    var i = this.playerListRow.clone();
    i.setLocalPosition(0, 25 * -this.playerCount, 0),
    i.enabled = !0,
    e && (i.findByName("Username").element.text = e + ""),
    this.playerListHolder.addChild(i),
    this.playerCount++,
    this.playerIdList.push(t)
}
,
Helicopter.prototype.setEnemyDeployPosition = function(t, e, i, n) {
    ...
    } else if (-1 == this.players.indexOf(t)) {
...
Helicopter.prototype.update = function(t) {
    ...
    this.topRotor && this.backRotor && (this.topRotor.rotateLocal(0, 40.1, 0),
...
BatchManager.attributes.add("maxGroupCount", {
    type: "number"
}),
...
BatchManager.prototype.optimize = function() {
    ...
    var t = this.mapEntity.findByTag("Batch");
    this.entities = t,
    this.app.fire("Physics:Update", !0),
    this.setCustomBatch(),
    this.setIndexBatch(),
...
,
BatchManager.prototype.setIndexBatch = function() {
    for (var t = this.entities.length, e = 0, a = []; t--; )
        a.push(this.entities[t]),
        ++e > this.maxGroupCount && (this.createBatchGroup(a),
        a = [],
        e = 0)
}
,
BatchManager.prototype.createBatchGroup = function(t) {
    var e = (Math.random() + " - ").slice(0, 5);
    this.prepare(e, t)
}
,
BatchManager.prototype.setPositionBatch = function(t, e) {
    for (var a = this.entities.length, i = new pc.Vec3(t * this.maxSize,0,e * this.maxSize), s = []; a--; ) {
        var n = this.entities[a].getPosition().clone()
          , r = i.clone().sub(n).length()
          , h = this.entities[a].children;
        for (var c in h) {
            var o = h[c];
            if (o.tags.list().indexOf("interactive") > -1) {
                var p = o.getPosition().clone()
                  , d = o.getEulerAngles().clone();
                o.reparent(this.dynamicWorld),
                o.setPosition(p),
                o.setEulerAngles(d)
            }
        }
        r <= this.maxSize && this.entities[a].tags.list().indexOf("Batch") > -1 && (s.push(this.entities[a]),
...
BatchManager.prototype.prepare = function(t, e) {
    ...
    for (var s in e) {
        var n = e[s];
        n.model && n.model.meshInstances && n.model.meshInstances.length > 0 && n.tags.list().indexOf("Batch") > -1 && (a = a.concat(n.model.meshInstances),
        n.model.batchGroupId = i.id)
    }
    var r = this.app.batcher.prepare(a, !1, this.maxSize, !1)
      , h = this.app.batcher.create(r, !1, i.id);
    this.batches.push(h),
...
,
Chat.prototype.addMessage = function(t, e, s) {
    if (!this.entity.enabled)
        return !1;
    var i = t ? t + "" : "Guest";
    s && (i = "Console"),
    void 0 !== e.replace && (e = (e = (e = e.replace(/\[/g, "")).replace(/\]/g, "")).replace(/\\/g, ""));
    var a = i + " : " + e;
    this.messageElement.element.text = a + "",
    this.messageIndex++;
    var n = this.messageRowEntity.clone();
    n.enabled = !0,
    n.username = n.findByName("Content"),
    n.background = n.findByName("Background"),
    n.tween(n.username.element).delay(this.notificationStayTime).to({
        opacity: 0
    }, this.fadeOutTime, pc.QuarticOut).start(),
    n.tween(n.background.element).delay(this.notificationStayTime).to({
        opacity: 0
    }, this.fadeOutTime, pc.QuarticOut).start(),
    n.setLocalPosition(0, 0, 0),
    this.messageBox.addChild(n),
...
Notification.prototype.initialize = function() {
    this.messages = [],
    this.messageIndex = 0,
    this.app.on("Interface:Notification", this._addNotification, this)
}
,
Notification.prototype._addNotification = function(t) {
...
Ambient.attributes.add("sceneNames", {
    type: "string",
    array: !0
}),
...
Ambient.prototype.initialize = function() {
    if (void 0 !== pc.selectedMap && (this.selectedMap = pc.selectedMap),
    this.currentIndex = this.maps.indexOf(this.selectedMap),
    this.currentMode = this.modes[this.currentIndex],
    pc.currentMode = this.currentMode,
    this.mapElements.length > 0)
        for (var e = this.mapElements.length; e--; )
            this.mapElements[e].element.textureAsset = this.mapImages[this.currentIndex];
    if (this.mapNames.length > 0)
        for (var t = this.mapNames.length; t--; )
            this.mapNames[t].element.text = this.maps[this.currentIndex];
    if (this.regions.length > 0) {
        for (var a = this.regions.length; a--; )
            this.regions[a].enabled = !1;
...
TeamSelection.attributes.add("waitingConnectionEntity", {
    type: "entity"
}),
...
TeamSelection.attributes.add("meColor", {
    type: "rgb"
}),
TeamSelection.prototype.initialize = function() {
    ...
    this.app.on("Player:Ready", this.connectGame, this),
    this.blueTeamPlayer.enabled = !1,
    this.redTeamPlayer.enabled = !1,
    setTimeout(function(e) {
        e.app.fire("Ads:BannerSet", "miniroyale2-io_728x90_2", "728x90")
    }, 100, this)
}
,
TeamSelection.prototype.checkUser = function(e) {
    for (var t = this.allPlayers.length, i = !1; t--; )
        this.allPlayers[t] && this.allPlayers[t].playerId == e && (i = !0);
    return i
}
,
TeamSelection.prototype.getPlayer = function(e) {
    for (var t = this.allPlayers.length, i = !1; t--; )
        this.allPlayers[t] && this.allPlayers[t].playerId == e && (i = this.allPlayers[t]);
    return i
}
,
...
TeamSelection.prototype.setTick = function(e) {
    ...
    this.app.fire("Ads:BannerDestroy", "miniroyale-728x90-team", "728x90"),
    ...
    this.waitingConnectionEntity.enabled = !1
}
,
...
,
TeamSelection.prototype.setJoinedPlayer = function(e, t, i, a, n, r, l, s) {
    if (this.checkUser(e))
        return !1;
    var o = pc.userId == e;
...
,
TeamSelection.prototype.onTeamSelection = function(e, t, i, a, n, r) {
    if (this.checkUser(e)) {
        var l = this.getPlayer(e);
        return l.team = t,
        l.level = n,
        l.skin = a,
        e == pc.userId && (pc.currentTeam = t),
        this.renderAllPlayers(),
        !1
    }
    var s = {
...
,
TeamSelection.prototype.renderAllPlayers = function() {
    this.clearPlayerRows();
    for (var e = this.allPlayers.length; e--; ) {
        var t = this.allPlayers[e];
        t && this.createPlayerRow(t.playerId, t.username, t.team, t.skin, t.level, t.isMe)
    }
}
,
TeamSelection.prototype.clearPlayerRows = function() {
    this.clearPlayerRow(this.blueTeamHolder),
    this.clearPlayerRow(this.redTeamHolder),
    this.teamCountBlue = 0,
    this.teamCountRed = 0,
    this.readyPlayers = 0,
    this.readyPlayersText.element.text = 'Ready : [color="#40CD11"]' + this.readyPlayers + "/10[/color]"
...
,
TeamSelection.prototype.clearPlayerRow = function(e) {
    for (var t = e.children.length; t--; )
        e.children[t] && e.children[t].destroy()
}
,
TeamSelection.prototype.createPlayerRow = function(e, t, i, a, n, r) {
    var l = !1
      , s = !1;
    if ("blue" === i && this.teamCountBlue >= 5)
        return !1;
    if ("red" === i && this.teamCountRed >= 5)
        return !1;
    if ("blue" != i && "red" != i)
        return !1;
    "blue" === i && (l = this.blueTeamHolder,
    s = this.blueTeamPlayer,
    this.blueTeamCount++),
    "red" === i && (l = this.redTeamHolder,
    s = this.redTeamPlayer,
    this.redTeamCount++);
    var o = s.clone()
      , y = isNaN(n) ? 0 : n;
    0 === y && (y = 1),
    ...
    o.playerId = e,
    o.team = i,
    o.findByName("Username").element.text = t,
    o.findByName("Level").element.text = y + "",
    "blue" == i ? (o.setLocalPosition(0, 45 * -this.teamCountBlue, 0),
    this.teamCountBlue++) : "red" == i && (o.setLocalPosition(0, 45 * -this.teamCountRed, 0),
    this.teamCountRed++),
    r && (this.blueTeamButton.enabled = !1,
    this.redTeamButton.enabled = !1,
    o.findByName("Background").element.color = this.meColor);
    var d = this.app.assets.find(a + "-CharacterThumbnail");
    d && (o.findByName("ProfilePicture").element.textureAsset = d),
    l.addChild(o),
    this.readyPlayers++,
    this.readyPlayersText.element.text = 'Ready : [color="#40CD11"]' + this.readyPlayers + "/10[/color]"
}
...
TeamSelection.prototype.getTeamCount = function(e) {
    return "blue" == e ? this.blueTeamCount : this.redTeamCount
}
,
TeamSelection.prototype.onPlayerLeave = function(e) {
    for (var t = this.allPlayers.length; t--; )
        this.allPlayers[t] && this.allPlayers[t].playerId == e[0] && (this.allPlayers[t] && this.allPlayers[t].entity && this.allPlayers[t].entity.destroy(),
...
InviteService.attributes.add("privateIconCheckboxActive", {
    type: "entity"
}),
InviteService.attributes.add("privateTextElement", {
    type: "entity"
}),
...
,
InviteService.prototype.sendChat = function(t) {
    if (this.isGameStarted)
        return !1;
    this.isAlreadyConnected && this.send(["chat", t])
}
,
...
InviteService.prototype.setPrivate = function() {
    ...
    this.privateIconCheckboxActive.enabled = this.isPrivate,
    this.isPrivate ? this.privateTextElement.element.text = "Only friends can join" : this.privateTextElement.element.text = "Everyone can join",
    this.send(["match", this.version, this.menuEntity.script.menu.maps.join(","), this.isPrivate, pc.country])
}
,
InviteService.prototype.setFriends = function(t) {
    this.friends = t,
    this.friends.length > 0 && this.send(["subscribe", this.friends])
}
,
InviteService.prototype.onOpen = function(t) {
    this.debug && console.log("Invite service is ready!"),
    this.isConnected = !0
}
,
InviteService.prototype.onMessage = function(t) {
    if (!t || !t.data)
        return !1;
    var e = this.decode(t.data)
      , i = e[0]
      , n = e.slice(1, e.length)
      , s = this.defaultVersion;
    if ("undefined" != typeof VERSION && (s = VERSION),
    this.version = s,
    this.debug && console.log("Event : ", this.decode(t.data)),
    "auth" === i && (this.send(["username", this.username, pc.currentSkin, pc.hat]),
    ...
    "chat" === i && n.length > 0 && !this.isGameStarted && this.app.fire("Event:Chat", n[0], n[1]),
    "offline" === i && n.length > 0 && this.app.fire("FriendList:Offline", n[0]),
    "invite" === i && n.length > 0) {
        this.menuEntity.script.menu.showConfirm(n[0] + " invites you game!");
        var r = this
          , a = n[0];
        pc.acceptCallback = function() {
            r.acceptInvite(a),
            r.menuEntity.script.menu.closeConfirm()
        }
        ,
        pc.declineCallback = function() {
            r.declineInvite(a),
    ...
    "party" === i && n.length > 0) {
        ...
        o = !0) : (console.log("Party removed"),
        this.currentPartyId = "none",
        this.app.fire("FriendList:JoinParty", "none"),
        this.chatEntity.enabled = !1,
        o = !1),
        this.inviteButton.enabled = !o,
        this.findMatchButton.enabled = !o,
        this.readyPartyButton.enabled = o,
        this.leavePartyButton.enabled = o,
        o && this.readyPartyButton.script.button.resolve(),
        o ? n.length > 1 && this.app.fire("InviteService:Join", n[1], n[2]) : this.app.fire("InviteService:Leave", !0)
    }
    "session" === i && n.length > 0 && (this.socket.close(),
    this.isGameStarted = !0,
    this.chatEntity.script.enabled = !1,
    this.chatEntity.enabled = !1,
    this.chatEntity.destroy(),
    this.app.fire("Menu:RemovePokiBanner", !0),
    this.menuEntity.script.menu.closeAllModals(),
    this.menuEntity.script.menu.disableBanners(),
    this.menuEntity.script.menu.hideAttachments(),
    pc.selectedMap = n[0],
    pc.network.IP = n[1],
    pc.network.roomId = n[2],
    pc.network.radiusId = n[3],
    pc.network.gameMode = n[4],
    this.app.fire("Menu:HideBanners", !0),
    setTimeout(function(t) {
        t.menuEntity.script.menu.loadScene("Loader")
    }, 100, this))
}
,
InviteService.prototype.acceptInvite = function(t) {
    this.send(["accept", t])
}
,
InviteService.prototype.declineInvite = function(t) {
    this.send(["decline", t]),
    this.chatEntity.enabled = !1
}
,
InviteService.prototype.sendInvite = function(t) {
    this.send(["invite", t])
}
,
...
,
InviteService.prototype.send = function(t) {
    if (!this.isConnected)
        return !1;
    this.socket.send(this.encode(t))
}
,
InviteService.prototype.encode = function(t) {
    return JSON.stringify(t)
}
,
InviteService.prototype.decode = function(t) {
    return JSON.parse(t)
}
;
...
;
var Points = pc.createScript("points");
Points.attributes.add("pointDisplay", {
    type: "entity"
}),
Points.attributes.add("cameraEntity", {
    type: "entity"
}),
Points.attributes.add("screenEntity", {
    type: "entity"
}),
Points.attributes.add("distanceFactor", {
    type: "number"
}),
Points.prototype.initialize = function() {
    this.pointDisplays = [],
    this.pointEntities = this.app.root.findByTag("PointIcon"),
    this.pointDisplay.enabled = !1,
    this.lastTimestamp = 0,
    this.timestamp = 0
}
,
Points.prototype.trackPoint = function(t, i, e) {
    if (!t)
        return !1;
    if (!this.pointDisplays[e]) {
        var s = this.pointDisplay.clone();
        s.enabled = !0,
        t && t.script && t.script.attr && (s.findByName("Icon").element.textureAsset = t.script.attr.icon,
        s.findByName("Icon").element.color = t.script.attr.color,
        s.findByName("Name").element.text = t.script.attr.name,
        t.distanceElement = s.findByName("Distance"),
        t.team = t.script.base.baseId),
        this.entity.addChild(s),
        t.display = s,
        this.pointDisplays[e] = s
    }
    var a = t.getPosition().clone()
      , n = new pc.Vec3;
    this.cameraEntity.camera.worldToScreen(a, n);
    var p = this.screenEntity.screen.scale
      , o = this.app.graphicsDevice
      , c = Math.floor(this.cameraEntity.getPosition().clone().sub(a).length() * this.distanceFactor);
    if (pc.currentTeam == t.team)
        return t.display.enabled = !1,
        !1;
    t.enabled && n.x > 0 && n.x < this.app.graphicsDevice.width && n.y > 0 && n.y < this.app.graphicsDevice.height && n.z > 0 ? (t.display.setLocalScale(1, 1, 1),
    t.display.setLocalPosition(n.x / p, (o.height - n.y) / p, 0),
    t.display.enabled = !0,
    t.distanceElement.element.text = c + "M") : t.enabled && n.y > 0 && n.y < this.app.graphicsDevice.height && n.z > 0 ? n.x > this.app.graphicsDevice.width ? (t.display.setLocalScale(.8, .8, .8),
    t.display.setLocalPosition(this.app.graphicsDevice.width / p, (o.height - n.y) / p, 0),
    t.display.enabled = !0,
    t.distanceElement.element.text = c + "M") : n.x < 0 ? (t.display.setLocalScale(.8, .8, .8),
    t.display.setLocalPosition(0, (o.height - n.y) / p, 0),
    t.display.enabled = !0,
    t.distanceElement.element.text = c + "M") : t.display.enabled = !1 : t.display.enabled = !1
}
,
Points.prototype.updatePoints = function(t) {
    if (this.lastTimestamp - this.timestamp < 1)
        return !1;
    for (var i = this.pointEntities.length; i--; ) {
        var e = this.pointEntities[i];
        e && this.trackPoint(e, t, i)
    }
    this.lastTimestamp = this.timestamp
}
,
Points.prototype.update = function(t) {
    this.updatePoints(t),
    this.timestamp += t
}
;
var RequestPassword = pc.createScript("requestPassword");
RequestPassword.attributes.add("emailInput", {
    type: "entity"
}),
RequestPassword.attributes.add("resetButton", {
    type: "entity"
}),
RequestPassword.attributes.add("messageEntity", {
    type: "entity"
}),
RequestPassword.attributes.add("alertElement", {
    type: "entity"
}),
RequestPassword.prototype.initialize = function() {}
,
RequestPassword.prototype.completeLoginAction = function() {
    this.resetButton.enabled = !1,
    this.messageEntity.enabled = !0
}
,
RequestPassword.prototype.resetAction = function() {
    var t = this
      , e = this.emailInput.script.input.getValue();
    Service.post("reset", {
        email: e
    }, function(e) {
        e.success ? (t.completeLoginAction(),
        t.resetButton.script.button.resolve()) : (t.alertElement.script.alert.show(e.message, 6e3),
        t.resetButton.script.button.resolve())
    }, Service.authURL)
}
;
var Base = pc.createScript("base");
Base.attributes.add("baseName", {
    type: "string"
}),
Base.attributes.add("baseId", {
    type: "string"
}),
Base.prototype.initialize = function() {
    ...
    this.app.on("Flag:Captured", this.onCapture, this),
    this.app.on("Flag:Saved", this.onSave, this),
    this.app.on("Base:Reset", this.onReset, this),
    this.app.on("Enemy:Capture", this.onEnemyCapture, this),
    this.app.on("Enemy:SaveFlag", this.onEnemySave, this)
}
,
Base.prototype.onReset = function() {
    this.entity.enabled = !0
}
,
Base.prototype.onEnemyCapture = function() {}
,
Base.prototype.onEnemySave = function() {
    this.entity.enabled = !0
}
,
Base.prototype.onCapture = function(e, t) {
    ("TeamRed" == this.baseName && "blue" == e || "TeamBlue" == this.baseName && "red" == e) && (this.entity.enabled = !1)
}
,
Base.prototype.onSave = function(e, t) {
    ("TeamRed" == this.baseName && "blue" == e || "TeamBlue" == this.baseName && "red" == e) && (this.entity.enabled = !0)
}
,
Base.prototype.onCollisionStart = function(e) {
    "Player" == e.name && this.app.fire("Base:Enter", this.baseName)
}
,
Base.prototype.onCollisionEnd = function(e) {
    "Player" == e.name && this.app.fire("Base:Leave", this.baseName)
}
;
var Score = pc.createScript("score");
Score.attributes.add("teamRedScore", {
    type: "entity"
}),
Score.attributes.add("teamBlueScore", {
    type: "entity"
}),
Score.attributes.add("resultRedScore", {
    type: "entity"
}),
Score.attributes.add("resultBlueScore", {
    type: "entity"
}),
Score.attributes.add("redColor", {
    type: "rgb"
}),
Score.attributes.add("blueColor", {
    type: "rgb"
}),
Score.attributes.add("meColor", {
    type: "rgb"
}),
Score.attributes.add("listElement", {
    type: "entity"
}),
Score.attributes.add("listHolder", {
    type: "entity"
}),
Score.attributes.add("maxLimit", {
    type: "number",
    default: 5
}),
Score.attributes.add("playerManager", {
    type: "entity"
}),
Score.prototype.initialize = function() {
    ...
    this.listElements = [],
    this.playerScores = {},
    this.listElement.enabled = !1,
    this.app.on("Score:SaveFlag", this.onSaveFlag, this),
    this.app.on("Team:Selection", this.setTeam, this),
    this.app.on("Player:Score", this.setScore, this),
    this.app.on("Player:Ready", this.onReady, this);
    var e = this.playerManager.script.playerManager.playersData;
    for (var t in this.players.push({
        playerId: pc.userId,
    ...
    e) {
        var r = e[t];
        this.onPlayerCreate(r.playerId, r.username, r.skin, r.team)
    }
}
,
Score.prototype.onReady = function() {
    var e = this.playerManager.script.playerManager.playersData;
    for (var t in e) {
        var r = e[t];
        for (var a in this.players) {
            var s = this.players[a];
            r.playerId == s.playerId && (this.players[a].team = r.team)
        }
    }
    this.renderScores()
}
,
Score.prototype.refreshTeams = function() {
    var e = this.playerManager.script.playerManager.playersData;
    for (var t in e) {
        var r = e[t];
        for (var a in this.players) {
...
,
Score.prototype.setTeam = function(e, t) {
    for (var r in this.players) {
        e == this.players[r].playerId && (this.players[r].team = t)
    }
}
,
Score.prototype.onPlayerCreate = function(e, t, r, a) {
    if (this.findByPlayerId(e))
        return !1;
    this.players.push({
        playerId: e,
...
,
Score.prototype.findByPlayerId = function(e) {
    var t = !1;
    for (var r in this.players) {
...
,
Score.prototype.clearScores = function() {
    for (var e = this.listElements.length; e--; )
        this.listElements[e] && this.listElements[e].destroy();
    this.listElements = []
}
,
Score.prototype.createListElement = function(e, t) {
    var r = this.listElement.clone();
    r.setLocalPosition(0, 25 * -t, 0),
    r.findByName("Background").element.opacity = t % 2 ? .1 : .2,
    r.findByName("Username").element.text = e.username ? e.username : "Guest",
    r.findByName("Score").element.text = e.score + "",
    r.findByName("Team").element.color = "red" == e.team ? this.redColor : this.blueColor,
    e.playerId == pc.userId && (r.findByName("Background").element.color = this.meColor),
    r.enabled = !0,
    this.listElements.push(r),
    this.listHolder.addChild(r)
}
,
Score.prototype.renderScores = function() {
    this.clearScores(),
    this.players.sort(function(e, t) {
        return t.score - e.score
    });
    var e = this.players.slice(0, this.maxLimit)
      , t = 0;
    for (var r in e) {
        var a = e[r];
        this.createListElement(a, t),
        t++
    }
    return !1
}
,
Score.prototype.setScore = function(e, t) {
    for (var r = this.players.length; r--; )
        this.players[r].playerId == e && (this.players[r].score = t);
    this.refreshTeams(),
    this.renderScores()
}
,
Score.prototype.onSaveFlag = function(e, t, r) {
    this.teamScores[t]++,
    this.teamRedScore.element.text = this.teamScores.red + "",
    this.teamBlueScore.element.text = this.teamScores.blue + "",
    this.resultRedScore.element.text = this.teamScores.red + "",
    this.resultBlueScore.element.text = this.teamScores.blue + ""
}
;
var PlayerNames = pc.createScript("playerNames");
PlayerNames.attributes.add("lookPoint", {
    type: "entity"
}),
PlayerNames.attributes.add("playerDisplay", {
    type: "entity"
}),
PlayerNames.attributes.add("cameraEntity", {
    type: "entity"
}),
PlayerNames.attributes.add("screenEntity", {
    type: "entity"
}),
PlayerNames.attributes.add("entityHolder", {
    type: "entity"
}),
PlayerNames.attributes.add("distanceFactor", {
    type: "number"
}),
PlayerNames.attributes.add("redColor", {
    type: "rgb"
}),
PlayerNames.attributes.add("blueColor", {
    type: "rgb"
}),
PlayerNames.prototype.initialize = function() {
    this.displays = [],
    this.lastVisibleState = !1,
    this.lastVisibleUpdate = Date.now(),
    this.playerEntities = [],
    this.lastUpdate = 0,
    this.getPlayerEntities(),
    this.headVector = new pc.Vec3(0,1,0),
    this.playerDisplay.enabled = !1,
    this.app.on("Game:Finished", this.onFinished, this),
    this.app.on("Player:Respawn", this.onPlayerSpawn, this),
    this.app.on("Player:Death", this.onPlayerDeath, this)
}
,
PlayerNames.prototype.onPlayerSpawn = function() {
    this.entityHolder.enabled = !0
}
,
PlayerNames.prototype.onPlayerDeath = function() {
    this.entityHolder.enabled = !1
}
,
PlayerNames.prototype.onFinished = function() {
    this.entity.enabled = !1
}
,
PlayerNames.prototype.cleanDisplays = function() {
    for (var e in this.displays) {
        var t = this.displays[e];
        t.player || t.destroy()
    }
}
,
PlayerNames.prototype.isVisible = function(e) {
    var t = this.app.systems.rigidbody.raycastFirst(this.lookPoint.getPosition(), e.clone());
    return !t || !t.entity || "Enemy" != t.entity.name
}
,
PlayerNames.prototype.trackPoint = function(e, t, a) {
    if (!e || !e.script || !e.script.enemy)
        return !1;
    if (!this.displays[a]) {
        var i = this.playerDisplay.clone();
        i.enabled = !0,
        i.player = e,
        e && e.script && e.script.enemy && (i.findByName("Username").element.text = e.script.enemy.username,
        e.team = "none",
        e.isDisplayed = !1,
        e.teamElement = i.findByName("Team"),
        e.originElement = i.findByName("Origin"),
        e.flagElement = i.findByName("Flag"),
        e.flagElement.enabled = !1),
        this.entityHolder.addChild(i),
        e.display = i,
        e.lastRay = Date.now(),
        this.displays[a] = i
    }
    var s = e.getPosition().clone().add(this.headVector);
    if (e.team != pc.currentTeam) {
        var l = this.isVisible(s);
        e.script.enemy.isCarryFlag ? e.isDisplayed = !0 : e.isDisplayed = !l
    } else
        e.isDisplayed = !0;
    if (e.flagElement && (e.script.enemy.isCarryFlag ? e.flagElement.enabled = !0 : e.flagElement.enabled = !1),
    e.script.enemy.team != e.team && ("red" == e.script.enemy.team ? e.teamElement.element.color = this.redColor : "blue" == e.script.enemy.team && (e.teamElement.element.color = this.blueColor),
    e.team = e.script.enemy.team,
    e.team == pc.currentTeam ? e.originElement.setLocalScale(.75, .75, .75) : e.originElement.setLocalScale(1, 1, 1)),
    !e.isDisplayed)
        return e.display.enabled = !1,
        !1;
    var n = new pc.Vec3;
    this.cameraEntity.camera.worldToScreen(s, n);
    var r = this.app.graphicsDevice.maxPixelRatio
      , y = this.screenEntity.screen.scale
      , p = this.app.graphicsDevice;
    Math.floor(this.cameraEntity.getPosition().clone().sub(s).length() * this.distanceFactor);
    n.x *= r,
    n.y *= r,
    e.enabled && n.x > 0 && n.x < this.app.graphicsDevice.width && n.y > 0 && n.y < this.app.graphicsDevice.height && n.z > 0 ? (e.display.setLocalScale(1, 1, 1),
    e.display.setLocalPosition(n.x / y, (p.height - n.y) / y, 0),
    e.display.enabled = !0) : e.enabled && n.y > 0 && n.y < this.app.graphicsDevice.height && n.z > 0 ? n.x > this.app.graphicsDevice.width ? (e.display.setLocalScale(.8, .8, .8),
    e.display.setLocalPosition(this.app.graphicsDevice.width / y, (p.height - n.y) / y, 0),
    e.display.enabled = !0) : n.x < 0 ? (e.display.setLocalScale(.8, .8, .8),
    e.display.setLocalPosition(0, (p.height - n.y) / y, 0),
    e.display.enabled = !0) : e.display.enabled = !1 : e.display && (e.display.enabled = !1)
}
,
PlayerNames.prototype.updatePoints = function(e) {
    for (var t = this.playerEntities.length; t--; ) {
        var a = this.playerEntities[t];
        this.trackPoint(a, e, a._guid)
    }
}
,
PlayerNames.prototype.getPlayerEntities = function() {
    if (Date.now() - this.lastUpdate < 2e3)
        return !1;
    this.playerEntities = this.app.root.findByTag("OnlinePlayer"),
    this.cleanDisplays(),
    this.lastUpdate = Date.now()
}
,
PlayerNames.prototype.update = function(e) {
    this.updatePoints(e),
    this.getPlayerEntities()
}
;
var ModeManager = pc.createScript("modeManager");
ModeManager.attributes.add("captureFlagElements", {
    type: "entity",
    array: !0
}),
ModeManager.attributes.add("battleRoyalElements", {
    type: "entity",
    array: !0
}),
ModeManager.prototype.initialize = function() {
    this.app.on("Game:Ready", this.setReady, this)
}
,
ModeManager.prototype.setReady = function() {
    "capture-the-flag" == pc.currentMode && (this.disableEntities(this.battleRoyalElements),
    this.enableEntities(this.captureFlagElements)),
    "battle-royale" == pc.currentMode && (this.disableEntities(this.captureFlagElements),
    this.enableEntities(this.battleRoyalElements))
}
,
ModeManager.prototype.disableEntities = function(e) {
    for (var t in e) {
        var a = e[t];
        a && (a.enabled = !1)
    }
...
,
ModeManager.prototype.enableEntities = function(e) {
    for (var t in e) {
        var a = e[t];
        a && (a.enabled = !0)
    }
...
;
var FlagManager = pc.createScript("flagManager");
FlagManager.attributes.add("flagEntity", {
    type: "entity"
}),
FlagManager.attributes.add("blueFlagEntity", {
    type: "entity"
}),
FlagManager.attributes.add("redFlagEntity", {
    type: "entity"
}),
FlagManager.attributes.add("borderEntity", {
    type: "entity"
}),
FlagManager.attributes.add("teamColorEntity", {
    type: "entity"
}),
FlagManager.attributes.add("redColor", {
    type: "rgb"
}),
FlagManager.attributes.add("blueColor", {
    type: "rgb"
}),
FlagManager.attributes.add("redMaterial", {
    type: "asset",
    assetType: "material"
}),
FlagManager.attributes.add("blueMaterial", {
    type: "asset",
    assetType: "material"
}),
FlagManager.attributes.add("blueBaseEntity", {
    type: "entity"
}),
FlagManager.attributes.add("redBaseEntity", {
    type: "entity"
}),
FlagManager.prototype.initialize = function() {
    this.currentColor = "none",
    this.baseName = "TeamRed",
    this.app.on("Flag:Fall", this.onFlagFall, this),
    this.app.on("Flag:Saved", this.onSaveFlag, this),
    this.app.on("Flag:BackCompleted", this.onFlagBack, this),
    this.app.on("Flag:Captured", this.onFlagCapture, this),
    this.app.on("Enemy:SaveFlag", this.onSaveFlag, this),
    this.blueFlagEntity.collision.on("triggerenter", this.onBlueCollision, this),
    this.blueFlagEntity.enabled = !1,
    this.redFlagEntity.collision.on("triggerenter", this.onRedCollision, this),
    this.redFlagEntity.enabled = !1
}
,
FlagManager.prototype.onFlagBack = function(t, e) {
    "blue" == e && (this.blueFlagEntity.enabled = !1,
    this.blueBaseEntity.enabled = !0),
    "red" == e && (this.redFlagEntity.enabled = !1,
    this.redBaseEntity.enabled = !0)
}
,
FlagManager.prototype.onFlagCapture = function(t, e) {
    "blue" == t && (this.blueFlagEntity.enabled = !1,
    this.blueBaseEntity.enabled = !0),
    "red" == t && (this.redFlagEntity.enabled = !1,
    this.redBaseEntity.enabled = !0)
}
,
FlagManager.prototype.onSaveFlag = function() {
    "red" == this.currentColor && (this.blueBaseEntity.enabled = !0),
    "blue" == this.currentColor && (this.redBaseEntity.enabled = !0)
}
,
FlagManager.prototype.onBlueCollision = function(t) {
    "Player" == t.name && this.app.fire("Base:Enter", "TeamBlue", !0)
}
,
FlagManager.prototype.onRedCollision = function(t) {
    "Player" == t.name && this.app.fire("Base:Enter", "TeamRed", !0)
}
,
FlagManager.prototype.onFlagFall = function(t, e) {
    "red" == t && (this.blueColor,
    this.blueMaterial),
    "blue" == t && (this.redColor,
    this.redMaterial),
    "blue" == t && (this.redFlagEntity.enabled = !0,
    this.redFlagEntity.baseName = "TeamRed",
    this.redFlagEntity.setPosition(e.clone().sub(new pc.Vec3(0,1,0)))),
    "red" == t && (this.blueFlagEntity.enabled = !0,
    this.blueFlagEntity.baseName = "TeamBlue",
    this.blueFlagEntity.setPosition(e.clone().sub(new pc.Vec3(0,1,0))))
}
;
var CircularMenu = pc.createScript("circularMenu");
CircularMenu.attributes.add("items", {
    type: "entity",
    array: !0
}),
CircularMenu.attributes.add("item", {
    type: "entity"
}),
CircularMenu.attributes.add("itemsHolder", {
    type: "entity"
}),
CircularMenu.attributes.add("arrowEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("circleSize", {
    type: "number",
    default: 310
}),
CircularMenu.attributes.add("circleFactor", {
    type: "number"
}),
CircularMenu.attributes.add("angleWidth", {
    type: "number",
    default: 100
}),
CircularMenu.attributes.add("weaponNameEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("weaponIconEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("weaponDamageEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("weaponCapacityEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("weaponAmmoTypeEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("weaponTypeEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("playerEntity", {
    type: "entity"
}),
CircularMenu.attributes.add("hoverColor", {
    type: "rgb"
}),
CircularMenu.attributes.add("defaultColor", {
    type: "rgb"
}),
CircularMenu.prototype.initialize = function() {
    this.item.enabled = !1,
    this.mouseX = 0,
    this.mouseY = 0,
    this.allItems = [],
    this.currentAngle = 0,
    this.activeItem = !1,
    this.additionalAngle = Math.PI,
    this.setItems(this.items),
    this.app.mouse.on("mousemove", this.mouseMove, this),
    this.app.mouse.on("mousedown", this.mouseDown, this)
}
,
CircularMenu.prototype.mouseDown = function(t) {
    if (!this.entity.enabled)
        return !1;
    this.activeItem && (this.app.mouse.enablePointerLock(),
    this.playerEntity.script.movement.setStartWeapon(this.activeItem.weaponEntity, this.activeItem.ammoEntity, 999),
    this.entity.enabled = !1)
}
,
CircularMenu.prototype.mouseMove = function(t) {
    if (!this.entity.enabled)
        return !1;
    this.mouseX = t.x,
    this.mouseY = t.y
...
,
CircularMenu.prototype.lookArrow = function() {
    var t = Utils.lookAt(this.mouseX, this.mouseY, this.centerX, this.centerY);
    this.arrowEntity.setLocalEulerAngles(0, 0, t * pc.math.RAD_TO_DEG),
    this.currentAngle = t + this.additionalAngle
}
,
CircularMenu.prototype.checkHoverWeapon = function() {
    this.resetHover();
    for (var t = this.allItems.length; t--; )
        this.allItems[t].angle > this.currentAngle - this.angleWidth && this.allItems[t].angle < this.currentAngle && this.setActiveWeapon(this.allItems[t])
}
,
CircularMenu.prototype.resetHover = function() {
    for (var t = this.allItems.length; t--; )
        this.allItems[t] != this.activeItem && (this.allItems[t].hoverEntity.setLocalScale(.001, .001, .001),
        this.allItems[t].setLocalScale(.9, .9, .9),
        this.allItems[t].iconEntity.element.color = this.defaultColor,
        this.allItems[t].strokeEntity.element.opacity = .2)
}
,
CircularMenu.prototype.setActiveWeapon = function(t) {
    if (this.activeItem == t)
        return !1;
    this.activeItem = t,
    t.strokeEntity.element.opacity = 1,
    t.hoverEntity.tween(t.hoverEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .2, pc.CircularInOut).start(),
    t.tween(t.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, .1, pc.CircularInOut).start(),
    t.iconEntity.element.color = this.hoverColor,
    this.weaponNameEntity.element.text = this.activeItem.weaponName,
    this.weaponIconEntity.element.textureAsset = this.activeItem.iconAsset,
    this.weaponDamageEntity.element.text = "Damage : " + this.activeItem.damage,
    this.weaponCapacityEntity.element.text = "Capacity : " + this.activeItem.capacity,
    this.weaponAmmoTypeEntity.element.text = this.activeItem.ammoType,
    this.weaponTypeEntity.element.text = this.activeItem.type
}
,
CircularMenu.prototype.setCenter = function() {
    this.centerX = window.innerWidth / 2,
    this.centerY = window.innerHeight / 2
}
,
CircularMenu.prototype.setItems = function(t) {
    for (var e = t.length; e--; )
        if (t[e]) {
            var i = e / t.length * Math.PI * 2
              , a = Math.cos(i - Math.PI / 2) * this.circleSize
              , n = Math.sin(i - Math.PI / 2) * this.circleSize
              , r = this.item.clone();
            r.setLocalPosition(a, n, 0),
            r.enabled = !0,
            r.angle = i,
            r.hoverEntity = r.findByName("Hover"),
            r.strokeEntity = r.findByName("Stroke"),
            r.iconEntity = r.findByName("Icon"),
            r.iconEntity.element.spriteAsset = t[e].script.weapon.maskIcon,
            r.weaponName = t[e].script.weapon.name,
            r.iconAsset = t[e].script.weapon.icon,
            r.damage = t[e].script.weapon.damage,
            r.capacity = t[e].script.weapon.clipCapacity,
            r.ammoType = Utils.clearName(t[e].script.weapon.ammoType),
            r.type = t[e].script.weapon.type,
            r.weaponEntity = t[e],
            r.ammoEntity = this.app.root.findByTag(t[e].script.weapon.ammoType)[0],
            this.itemsHolder.addChild(r),
            this.allItems.push(r),
            0
        }
}
,
CircularMenu.prototype.update = function(t) {
    this.setCenter(),
    this.lookArrow(),
    this.checkHoverWeapon()
}
;
var Table = pc.createScript("table");
Table.attributes.add("tableId", {
    type: "string"
}),
Table.attributes.add("loading", {
    type: "entity"
}),
Table.attributes.add("rowEntity", {
    type: "entity"
}),
Table.attributes.add("rowHolder", {
    type: "entity"
}),
Table.attributes.add("columnEntities", {
    type: "entity",
    array: !0
}),
Table.attributes.add("columnKeys", {
    type: "string",
    array: !0
}),
Table.attributes.add("rowHeight", {
    type: "number"
}),
Table.attributes.add("hoverColor", {
    type: "rgb"
}),
Table.prototype.initialize = function() {
    this.rows = [],
    this.app.on("Table:Set", this.onTableSet, this),
    this.rowEntity.enabled = !1,
    this.loading.enabled = !0
}
,
Table.prototype.onTableSet = function(t, e) {
    this.tableId == t && (this.clearRows(),
    this.setRows(e),
...
Table.prototype.clearRows = function() {
    for (var t = this.rows.length; t--; )
        this.rows[t] && (this.rows[t].destroy(),
        this.rows.splice(t, 1))
}
,
Table.prototype.setRows = function(t) {
    for (var e in t) {
        var i = t[e];
        this.setRow(i)
    }
...
,
Table.prototype.setRow = function(t) {
    var e = this.rowEntity.clone();
    e.enabled = !0,
    e.setLocalPosition(0, -this.rowHeight * this.rows.length, 0),
    t.isHover && (e.findByName("Background").element.color = this.hoverColor);
    for (var i = this.columnEntities.length; i--; ) {
        var a = e.findByName(this.columnEntities[i].name);
        if (this.columnEntities[i].element.type == pc.ELEMENTTYPE_IMAGE) {
            var s = this.app.assets.find(t[this.columnKeys[i]] + "-CharacterThumbnail");
            s && (a.element.textureAsset = s)
        } else
            a.element.text = t[this.columnKeys[i]] + ""
    }
    this.rowHolder.addChild(e),
    this.rows.push(e)
}
;
var Selection = pc.createScript("selection");
Selection.attributes.add("checked", {
    type: "boolean"
}),
Selection.attributes.add("checkedColor", {
    type: "rgb"
}),
Selection.attributes.add("defaultColor", {
    type: "rgb"
}),
Selection.attributes.add("maps", {
    type: "string",
    array: !0
}),
Selection.prototype.initialize = function() {
    this.checkIcon = this.entity.findByName("CheckIcon"),
    this.backgroundImage = this.entity.findByName("Background"),
    this.selected = this.checked,
    this.entity.element.on("mousedown", this.onClick, this),
    this.entity.element.on("mouseenter", this.onHover, this),
    this.entity.element.on("mouseleave", this.onLeave, this),
    null !== window.localStorage.getItem(this.entity._guid) && this.setValue(window.localStorage.getItem(this.entity._guid))
}
,
Selection.prototype.onHover = function(e) {
    document.body.style.cursor = "pointer"
}
,
Selection.prototype.onLeave = function(e) {
    document.body.style.cursor = "default"
}
,
Selection.prototype.onClick = function(e) {
    this.selected = !this.selected,
    window.localStorage.setItem(this.entity._guid, this.selected),
    this.setDisplay(),
    this.app.fire("Overlay:Modes", !0)
}
,
Selection.prototype.setValue = function(e) {
    var t = "true" == e;
    this.selected = t,
    this.setDisplay()
}
,
Selection.prototype.setDisplay = function() {
    this.selected ? (this.checkIcon.element.textureAsset = this.app.assets.find("checkbox-checked.png"),
    this.backgroundImage.element.color = this.checkedColor) : (this.checkIcon.element.textureAsset = this.app.assets.find("checkbox.png"),
    this.backgroundImage.element.color = this.defaultColor)
}
;
...
MapManager.attributes.add("gameHolder", {
    type: "entity"
}),
...
MapManager.prototype.initialize = function() {
    var a = this
      , e = pc.app.assets.findByTag("Map-Models");
    this.loadedAssetCount = 0,
    this.totalAssetCount = e.length,
    e.forEach(function(e) {
        pc.app.assets.load(e),
        e.ready(function() {
            a.loaded()
        })
    }),
    void 0 !== pc.selectedMap && (this.defaultMap = pc.selectedMap)
}
,
MapManager.prototype.loaded = function() {
    this.totalAssetCount - 1 == this.loadedAssetCount && this.loadMap(this.defaultMap),
...
MapManager.prototype.loadMap = function(a) {
    this.clearHolder();
    var e = this
      , t = this.app.scenes.find(a).url;
    "undefined" != typeof VERSION && (t = t + "?v=" + VERSION),
    this.app.scenes.loadSceneHierarchy(t, function(a, p) {
        e.app.scenes.loadSceneSettings(t, function(a, t) {
            p.reparent(e.mapHolder),
            e.loadGame(),
            e.app.fire("Map:Loaded", !0)
        })
    })
}
,
MapManager.prototype.loadGame = function() {
    var a = this
      , e = this.app.scenes.find("Game").url;
    "undefined" != typeof VERSION && (e = e + "?v=" + VERSION),
    this.app.scenes.loadSceneHierarchy(e, function(e, t) {
        t.reparent(a.gameHolder)
    })
}
,
MapManager.prototype.clearHolder = function() {
    for (var a = this.mapHolder.children, e = a.length; e--; )
        a[e].destroy()
}
;
var LoadingOut = pc.createScript("loadingOut");
LoadingOut.attributes.add("transitionEntity", {
    type: "entity"
}),
LoadingOut.prototype.initialize = function() {
    this.app.on("Map:Loaded", this.onLoad, this)
}
,
LoadingOut.prototype.onLoad = function() {
    setTimeout(function(t) {
        t.fadeOut()
    }, 1500, this)
}
,
LoadingOut.prototype.fadeOut = function() {
    this.transitionEntity.tween(this.transitionEntity.getLocalPosition()).to({
        x: -2e3,
        y: -215,
        z: 0
...
Select.attributes.add("triggerEvent", {
    type: "string"
}),
Select.prototype.initialize = function() {
    ...
    this.onCreate(),
    this.on("state", function(e) {
        this.entity.enabled ? this.onCreate() : this.element && this.element.remove()
    }, this),
    this.app.on("DOM:Update", this.onResize, this),
    this.entity.on("destroy", this.onDestroy, this)
}
,
Select.prototype.onResize = function() {
    this.updateStyle()
}
,
Select.prototype.onCreate = function() {
    ...
    this.element.style.fontSize = this.fontSize + this.scaleUnit,
    this.element.style.boxSizing = "border-box";
    var e = "rgb(" + 255 * this.color.r + ", " + 255 * this.color.g + ", " + 255 * this.color.b + ")";
    for (var t in this.element.style.color = e,
    this.element.style.outline = "none",
    document.body.appendChild(this.element),
    this.options) {
        ...
        n.value = this.keys[t],
        n.innerText = i,
        this.defaultIndex == parseInt(t) && (n.selected = !0),
        this.element.appendChild(n)
    }
    if (this.element.selectedIndex = this.defaultIndex,
    this.element.onchange = this.onChange.bind(this),
    this.storeValue) {
        var s = window.localStorage.getItem(this.entity.name);
        if (s) {
            var l = this.keys.indexOf(s);
            this.element.selectedIndex = l
        }
    }
    this.updateStyle()
}
...
Select.prototype.onDestroy = function() {
    ...
    this.app.off("DOM:Resize")
}
,
Select.prototype.onChange = function() {
    this.storeValue && window.localStorage.setItem(this.entity.name, this.keys[this.element.selectedIndex]),
    this.triggerEvent && this.app.fire(this.triggerEvent, !0)
}
,
...
Form.attributes.add("inputEntities", {
    type: "entity",
    array: !0
}),
Form.attributes.add("inputKeys", {
    type: "string",
    array: !0
}),
Form.attributes.add("route", {
    type: "string"
}),
Form.attributes.add("contentEntity", {
    type: "entity"
}),
Form.attributes.add("successEntity", {
    type: "entity"
}),
Form.attributes.add("successMessageEntity", {
    type: "entity"
}),
Form.attributes.add("errorEntity", {
    type: "entity"
}),
Form.attributes.add("errorMessageEntity", {
    type: "entity"
}),
Form.attributes.add("showSuccess", {
    type: "boolean",
    default: !0
}),
Form.attributes.add("showCopyable", {
    type: "boolean",
    default: !1
}),
Form.prototype.initalize = function() {
    this.successEntity.enabled = !1,
    this.errorEntity.enabled = !1
}
,
Form.prototype.post = function(t) {
    var e = {}
      , s = this;
    for (var i in this.inputKeys) {
        var r = this.inputKeys[i]
          , n = this.inputEntities[i].script;
        n.input ? e[r] = n.input.getValue() : n.checkbox && (e[r] = n.checkbox.getValue())
    }
    Service.post(this.route, e, function(e) {
        e.success ? (s.showCopyable && window.prompt("Copy the link", e.message),
        s.showSuccess && (s.successEntity.enabled = !0,
        s.contentEntity.enabled = !1,
        s.successMessageEntity && (s.successMessageEntity.element.text = e.message)),
        s.errorEntity.enabled = !1) : (s.showSuccess && (s.successEntity.enabled = !1),
        s.errorEntity.enabled = !0,
        s.contentEntity && (s.contentEntity.enabled = !0),
        s.errorMessageEntity && (s.errorMessageEntity.element.text = e.message)),
        t.resolve()
    })
}
;
var List = pc.createScript("list");
List.attributes.add("keys", {
    type: "string",
    array: !0
}),
List.attributes.add("types", {
    type: "string",
    array: !0
}),
List.attributes.add("rowEntity", {
    type: "entity"
}),
List.attributes.add("holderEntity", {
    type: "entity"
}),
List.attributes.add("route", {
    type: "string"
}),
List.prototype.initialize = function() {
    var t = this;
    this.rowEntity.enabled = !1,
    Service.post(this.route, {}, function(e) {
        if (e.success)
            for (var i in e.list) {
                var r = e.list[i]
                  , s = t.rowEntity.clone();
                for (var n in s.enabled = !0,
                s.findByName("Background").element.opacity = i % 2 ? .1 : .05,
                s.setLocalPosition(0, -s.element.height * i, 0),
                t.keys) {
                    var a = t.keys[n];
                    "text" == t.types[n] ? s.findByName(a).element.text = r[a] : "button" == t.types[n] && (s.findByName(a).script.button.triggerFunction = r[a])
                }
                t.holderEntity.addChild(s)
            }
    })
}
;
...
RoomManager.attributes.add("serverTextEntity", {
    type: "entity"
}),
RoomManager.attributes.add("mapTextEntity", {
    type: "entity"
}),
RoomManager.attributes.add("selectServer", {
    type: "entity"
}),
RoomManager.attributes.add("selectMap", {
    type: "entity"
}),
RoomManager.prototype.initialize = function() {
    ...
    this.reconnect(),
    this.app.on("RoomManager:Open", this.onRoomOpen, this),
    this.app.on("RoomManager:Copy", this.onCopy, this),
    this.app.on("RoomManager:Change", this.onChange, this),
...
,
RoomManager.prototype.onRoomOpen = function() {
    var t = Utils.makeid(6);
    t = t.toLocaleUpperCase(),
    window.location.hash = t,
    this.app.fire("Popup:Open", "CustomGame"),
    this.sessionLink.script.input.setValue("https://miniroyale2.io/#" + t)
}
,
RoomManager.prototype.startMatchmaking = function() {
    this.app.fire("RoomManager:Matchmaking", !0),
    this.app.fire("Fetcher:Match", !0)
}
,
RoomManager.prototype.onCopy = function() {
    Utils.copyToClipboard(this.sessionLink.script.input.getValue()),
    this.app.fire("Menu:ShowAlert", "Link copied!")
}
,
...
,
RoomManager.prototype.onLeave = function() {
    this.ws && (this.ws.close(),
    this.ws = !1),
    window.location.hash = "",
    this.isMatchmaking = !1,
    this.app.fire("Menu:ShowAlert", "Session is canceled!"),
    this.app.fire("Popup:Close", "CustomGame"),
...
RoomManager.prototype.setSession = function() {
    pc.username && pc.hash ? (this.hash = pc.hash,
    this.username = pc.username) : this.hash = !1;
    var t = window.localStorage.getItem("miniroyale2_account_details");
    if (t && "none" == this.username) {
        var e = JSON.parse(t).username;
        this.username = e
    }
}
,
...
RoomManager.prototype.room = function(t) {
    ...
    if (t.length > 0) {
        var e = t[0]
          , i = t[1]
          , o = t[2];
        e.length > 0 && (this.playerCountEntity.element.text = e.length + " / " + this.maxPlayers,
        this.setFriendList(e),
        this.currentUsernames = e),
        i ? this.app.fire("View:Match", "Owner") : (this.app.fire("Popup:Open", "CustomGame"),
        this.app.fire("View:Match", "Room"),
        this.sessionLink.script.input.setValue("https://miniroyale2.io/#" + this.getRoomId())),
        this.private([o])
    }
}
,
...
RoomManager.prototype.setFriendList = function(t) {
    ...
    for (var i in t) {
        ...
        if (parseInt(i) > 0) {
            ...
            s.findByName("Username").element.text = o,
...
RoomManager.prototype.onStart = function() {
    1 === this.currentUsernames.length ? this.app.fire("Menu:ShowAlert", "Please wait for friends!") : this.send([this.keys.start])
}
,
...
,
RoomManager.prototype.onChange = function() {
    var t = this.selectServer.script.select.getValue()
      , e = this.selectMap.script.select.getValue();
    t && e && this.send([this.keys.change, t, e])
}
,
RoomManager.prototype.change = function(t) {
    t.length > 0 && (this.currentServer = t[0],
    this.currentMap = t[1],
    this.serverTextEntity.element.text = this.currentServer,
    this.mapTextEntity.element.text = this.currentMap)
}
,
RoomManager.prototype.start = function(t) {
    ...
    var e = t[0]
      , i = this.getRoomId()
      , o = t[1]
      , n = "secure-server-eu.miniroyale2.io";
    "EU" == e ? n = "secure-server-eu.miniroyale2.io" : "NA" == e ? n = "secure-server-us.miniroyale2.io" : "AU" == e && (n = "secure-server-au-1.miniroyale2.io"),
    this.app.fire("Popup:Close", "CustomGame"),
    setTimeout(function(t) {
        t.app.fire("Menu:RequestMatch", n, i, o)
    }, 100, this),
    this.ws && (this.ws.close(),
    this.ws = !1)
}
...
Template.prototype.refreshComponents = function(e) {
    ...
    for (var r in t) {
        var a = t[r];
        a && a.script && a.script.visibility && a.script.visibility.trigger(e),
        a && a.script && a.script.bar && a.script.bar.setValue(e)
    }
}
,
Template.prototype.onUpdate = function(e) {
    ...
    for (var t = this.entity.findByTag("Dynamic"), r = t.length; r--; ) {
        var a = t[r];
        if (a && a.enabled) {
            if (a.element.type == pc.ELEMENTTYPE_TEXT) {
                var i = a.element.text;
                a.element.source ? a.element.text = a.element.source + "" : a.element.source = i,
                a.element.text = this.render(e, a.element.text)
            }
            if (a.element.type == pc.ELEMENTTYPE_IMAGE) {
                var n = a.element.textureAsset
                  , s = this.getAsset(e, a.name);
                if (a.element.sourceImage = n,
                a.element.sourceImage) {
                    var o = a.element.sourceImage;
                    a.element.textureAsset = o
                } else
                    a.element.sourceImage = n;
                s && (a.element.textureAsset = s)
            }
        }
    }
...
"undefined" == typeof blockAdBlock ? adblocked = !0 : blockAdBlock.onDetected(function() {
    adblocked = !0
}),
...
AdsManager.prototype.initialize = function() {
    "undefined" != typeof VERSION && void 0 !== adblocked && !0 === adblocked && (isAdsBlocked = !0),
    this.lastPokiBannerContainer = !1,
    "undefined" != typeof adsProvider ? this.type = adsProvider.type : (this.type = this.setAdsProvider(),
    this.initalizeSDK()),
...
AdsManager.prototype.onBannerSet = function(e, t) {
    ...
    if ("Adinplay" == this.type)
        ...
        o ? (o.innerHTML = '<div class="adsbyvli" data-ad-slot="' + this.bannerSlotId + '"></div>',
        setTimeout(function(e) {
            (vitag.Init = window.vitag.Init || []).push(function() {
                viAPItag.display(e.bannerSlotId)
            })
        }, 100, this)) : setTimeout(function(o) {
            o.onBannerSet(e, t)
        }, 500, this)
    } else if ("Poki" == this.type && "undefined" != typeof PokiSDK) {
        ...
        i ? (PokiSDK.displayAd(i, t),
        this.lastPokiBannerContainer = i) : setTimeout(function(o) {
            o.onBannerSet(e, t)
        }, 500, this)
    }
}
...
AdsManager.prototype.onRewardAds = function(e, t) {
    ...
    isAdsBlocked ? (this.onPrerollCompleted(),
    t && t(),
    !1) : SDKLoaded ? void ("MobileAds" == this.type ? mobileAds.reward() : "VLI" == this.type ? (vitag.Init = window.vitag.Init || []).push(function() {
        viAPItag.startPreRoll(o.prerollSlotId)
    }) : "Adinplay" == this.type ? "undefined" != typeof adplayer ? aiptag.cmd.player.push(function() {
        adplayer.startPreRoll()
    }) : this.onPrerollCompleted() : "Poki" == this.type && ("undefined" != typeof PokiSDK ? PokiSDK.rewardedBreak().then(function() {
        o.onPrerollCompleted()
    }).catch(function() {
        o.onPrerollCompleted()
    }) : this.onPrerollCompleted())) : (this.onPrerollCompleted(),
    t && t(),
    !1)
}
,
AdsManager.prototype.onPreroll = function(e, t) {
    ...
    isAdsBlocked ? (this.onPrerollCompleted(),
    t && t(),
    !1) : SDKLoaded ? void ("MobileAds" == this.type ? Date.now() - this.startDate > 8e4 ? mobileAds.show() : this.onPrerollCompleted() : "VLI" == this.type ? (vitag.Init = window.vitag.Init || []).push(function() {
        viAPItag.startPreRoll(o.prerollSlotId)
    }) : "Adinplay" == this.type ? "undefined" != typeof adplayer && Date.now() - this.startDate > 8e4 ? aiptag.cmd.player.push(function() {
        adplayer.startPreRoll()
    }) : this.onPrerollCompleted() : "Poki" == this.type && ("undefined" != typeof PokiSDK ? PokiSDK.commercialBreak().then(function() {
        o.onPrerollCompleted()
    }).catch(function() {
        o.onPrerollCompleted()
    }) : this.onPrerollCompleted())) : (this.onPrerollCompleted(),
...
AdsManager.prototype.initalizeAdinplay = function() {
    var e = this
      , t = document.createElement("script");
    t.src = "//api.adinplay.com/libs/aiptag/pub/SHP/miniroyale2.io/tag.min.js",
    t.onload = function() {
        e.onAdinplay()
    }
    ,
...
AdsManager.prototype.initalizeSDK = function() {
    "None" == this.type || ("MobileAds" == this.type ? this.onMobileAds() : "Poki" == this.type ? this.initalizePokiSDK() : "VLI" == this.type ? this.initalizeVLISDK() : this.initalizeAdinplay()),
    console.log("Ads provider : ", this.type)
}
,
AdsManager.prototype.setAdsProvider = function() {
    return window.location && window.location.href.search("no-ads") > -1 ? "None" : "undefined" != typeof mobileAds ? "MobileAds" : window.location && window.location.href.search("poki") > -1 ? "Poki" : this.defaultProvider
}
;
